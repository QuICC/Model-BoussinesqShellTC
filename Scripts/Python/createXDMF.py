...
def main(argv):
    ...
    if scheme in [b'TTT']:
        ...
        gMid = 'theta'
        gFast = 'z'
    elif scheme in [b'SLFm', b'SLFl', b'BLFl', b'BLFm', b'WLFl', b'WLFm']:
        gSlow = 'r'
        gMid = 'theta'
        gFast = 'phi'
    elif scheme in [b'TT']:
    ...
    for fId in range(sId, sId+snapshots):
        ...
        elif scheme in [b'CFT', b'WFT', b'AFT', b'BLFl', b'BLFm', b'SLFm', b'SLFl', b'WLFl', b'WLFm']:
            if fId == sId:
                if scheme in [b'CFT',b'WFT']:
                    ...
                    gridfunc = annulusXYZ
                    gridfname = 'annulus'
                elif scheme in [b'BLFl',b'BLFm',b'WLFl',b'WLFm']:
                    gridfunc = sphereXYZ
                    gridfname = 'sphere'
