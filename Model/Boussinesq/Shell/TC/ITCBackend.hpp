/**
 * @file ITCBackend.hpp
 * @brief Base model backend for TC model
 */

#ifndef QUICC_MODEL_BOUSSINESQ_SHELL_TC_ITCBACKEND_HPP
#define QUICC_MODEL_BOUSSINESQ_SHELL_TC_ITCBACKEND_HPP
...
namespace TC {
   ...
   /**
    * @brief Base model backed for TC model
    */
   class ITCBackend: public ISphericalModelBackend
   {
      public:
         /**
          * @brief Constructor
      ...
      protected:
          ...
          * @param nds     Nondimensional parameters
          */
         void applyGalerkinStencil(SparseMatrix& decMat, const SpectralFieldId& rowId, const SpectralFieldId& colId, const int lr, const int lc, const Resolution& res, const BcMap& bcs, const NonDimensional::NdMap& nds) const override;
...
#endif // QUICC_MODEL_BOUSSINESQ_SHELL_TC_ITCBACKEND_HPP
