...
#ifndef QUICC_MODEL_BOUSSINESQ_SHELL_TC_EXPLICIT_MODELBACKEND_HPP
#define QUICC_MODEL_BOUSSINESQ_SHELL_TC_EXPLICIT_MODELBACKEND_HPP
...
protected:
    ...
    */
   void implicitBlock(DecoupledZSparse& decMat, const SpectralFieldId& rowId,
      const SpectralFieldId& colId, const int matIdx, const Resolution& res,
      const std::vector<MHDFloat>& eigs, const NonDimensional::NdMap& nds,
      const bool isSplitOperator) const;
    ...
    * @param nds           Nondimensional parameters
    */
   void timeBlock(DecoupledZSparse& decMat, const SpectralFieldId& fieldId,
      const int matIdx, const Resolution& res,
    ...
    * @param nds           Nondimensional parameters
    */
   void splitBoundaryValueBlock(DecoupledZSparse& decMat,
