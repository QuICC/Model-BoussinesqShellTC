...
namespace TestSuite {
   ...
   /**
    * @brief Test fixture for the SphericalChebyshevOperator implementation
    */
   class SphericalChebyshevOperatorTest : public ::testing::Test {
      public:
      ...
      protected:
          ...
          * @brief Constructor
          */
         SphericalChebyshevOperatorTest();

         /**
          * @brief Destructor
          */
         virtual ~SphericalChebyshevOperatorTest();
   ...
   SphericalChebyshevOperatorTest::SphericalChebyshevOperatorTest()
   {
      // Initilise framework
      FrameworkMacro::init();
...
//   void SphericalChebyshevOperatorTest::SetUp()
//   {
//   }

//   void SphericalChebyshevOperatorTest::TearDown()
//   {
//   }
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, Diff1)
   {
      ...
      Spectral::SphericalChebyshevOperator   op(nN);
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, Diff2)
   {
      // Set spectral and physical sizes
      int maxN = 6;
      int nN = maxN + 1;
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiIdentity)
   {
      // Set size of the basis
      int nN = 16;

      // Create Chebyshev spectral operator
      Spectral::SphericalChebyshevOperator   spec(nN);
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiInverse10)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiInverse20)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiInverse40)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiInverse11)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiInverse21)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalChebyshevOperatorTest, QuasiInverse42)
   {
      // Set size of the basis
      int nN = 16;
