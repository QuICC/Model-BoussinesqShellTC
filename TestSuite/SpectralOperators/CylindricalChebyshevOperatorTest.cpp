/** 
 * @file CylindricalChebyshevOperatorTest.cpp
 * @brief Implementation of test case for CylindricalChebyshevOperator
...
namespace TestSuite {
   ...
   /**
    * @brief Test fixture for the CylindricalChebyshevOperator implementation
    */
   class CylindricalChebyshevOperatorTest : public ::testing::Test {
      public:
      ...
      protected:
          ...
          * @brief Constructor
          */
         CylindricalChebyshevOperatorTest();

         /**
          * @brief Destructor
          */
         virtual ~CylindricalChebyshevOperatorTest();
   ...
   CylindricalChebyshevOperatorTest::CylindricalChebyshevOperatorTest()
   {
      // Initilise framework
      FrameworkMacro::init();
...
//   void CylindricalChebyshevOperatorTest::SetUp()
//   {
//   }

//   void CylindricalChebyshevOperatorTest::TearDown()
//   {
//   }
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, Diff1)
   {
      ...
      Spectral::CylindricalChebyshevOperator   op(nN);
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, Diff2)
   {
      // Set spectral and physical sizes
      int maxN = 6;
      int nN = maxN + 1;
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiIdentity)
   {
      // Set size of the basis
      int nN = 16;

      // Create Chebyshev spectral operator
      Spectral::CylindricalChebyshevOperator   spec(nN);
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiInverse10)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiInverse20)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiInverse40)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiInverse11)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiInverse21)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(CylindricalChebyshevOperatorTest, QuasiInverse42)
   {
      // Set size of the basis
      int nN = 16;
