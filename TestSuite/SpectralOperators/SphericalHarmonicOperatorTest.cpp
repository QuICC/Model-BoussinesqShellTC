/** \file SphericalHarmonicOperatorTest.cpp
 *  \brief Implementation of test case for SphericalHarmonicOperator
 */
...
namespace TestSuite {
   ...
   /**
    * @brief Test fixture for the SphericalHarmonicOperator implementation
    */
   class SphericalHarmonicOperatorTest : public ::testing::Test {
      public:
      ...
      protected:
          ...
          * @brief Constructor
          */
         SphericalHarmonicOperatorTest();

         /**
          * @brief Destructor
          */
         virtual ~SphericalHarmonicOperatorTest();
   ...
   SphericalHarmonicOperatorTest::SphericalHarmonicOperatorTest()
   {
      // Initilise framework
      FrameworkMacro::init();
...
//   void SphericalHarmonicOperatorTest::SetUp()
//   {
//   }

//   void SphericalHarmonicOperatorTest::TearDown()
//   {
//   }
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, Diff1)
   {
      ...
      Spectral::SphericalHarmonicOperator   op(nN);
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, Diff2)
   {
      // Set spectral and physical sizes
      int maxN = 6;
      int nN = maxN + 1;
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiIdentity)
   {
      // Set size of the basis
      int nN = 16;

      // Create Chebyshev spectral operator
      Spectral::SphericalHarmonicOperator   spec(nN);
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiInverse10)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiInverse20)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiInverse40)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiInverse11)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiInverse21)
   {
      // Set size of the basis
      int nN = 16;
    ...
    */
   TEST_F(SphericalHarmonicOperatorTest, QuasiInverse42)
   {
      // Set size of the basis
      int nN = 16;
