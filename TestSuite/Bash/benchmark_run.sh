...
do
   ...
   runpath=${QUICC_APPROX}/${QUICC_GEOMETRY}/${QUICC_MODEL}/${QUICC_MPIALGO}/${QUICC_TIMESTEPPER}/${QUICC_SPLINALG}/${QUICC_THREADS}/${QUICC_MEMORYUSAGE}/${QUICC_PLATFORM}/${QUICC_DIM1D}/${QUICC_DIM2D}/${QUICC_DIM3D}/${QUICC_DT}/
   cd ${runpath}
