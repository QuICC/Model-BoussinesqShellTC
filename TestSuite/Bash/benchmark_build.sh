...
if [ "$#" -lt 4 ]; then
    ...
    echo "Usage:"
    echo "benchmark_build.sh /project/dir /benchmark/dir benchmark_list.dat [ncpu] [parallel_make]"
    exit 1
fi
...
do
   ...
   if [ ! "${comppath}" == "${QUICC_APPROX}/${QUICC_GEOMETRY}/${QUICC_MODEL}/${QUICC_MPIALGO}/${QUICC_TIMESTEPPER}/${QUICC_SPLINALG}/${QUICC_FFT}/${QUICC_THREADS}/${QUICC_MEMORYUSAGE}/${QUICC_PLATFORM}" ];
   then
   ...
   runpath=${QUICC_APPROX}/${QUICC_GEOMETRY}/${QUICC_MODEL}/${QUICC_MPIALGO}/${QUICC_TIMESTEPPER}/${QUICC_SPLINALG}/${QUICC_FFT}/${QUICC_THREADS}/${QUICC_MEMORYUSAGE}/${QUICC_PLATFORM}/${QUICC_DIM1D}/${QUICC_DIM2D}/${QUICC_DIM3D}/${QUICC_DT}/${QUICC_GITHASH}/
   if [ -d ${runpath} ];
   then
   ...
   comppath=${QUICC_APPROX}/${QUICC_GEOMETRY}/${QUICC_MODEL}/${QUICC_MPIALGO}/${QUICC_TIMESTEPPER}/${QUICC_SPLINALG}/${QUICC_FFT}/${QUICC_THREADS}/${QUICC_MEMORYUSAGE}/${QUICC_PLATFORM} 
