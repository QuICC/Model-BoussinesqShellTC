/** 
 * @file SphericalChebyshevFftTransformTest.cpp
...
namespace TestSuite {
    ...
    */
   class SphericalChebyshevFftTransformTest : public ::testing::Test {
      public:
      ...
      protected:
          ...
          * @brief Constructor
          */
         SphericalChebyshevFftTransformTest();

         /**
          * @brief Destructor
          */
         virtual ~SphericalChebyshevFftTransformTest();
   ...
   SphericalChebyshevFftTransformTest::SphericalChebyshevFftTransformTest()
      : mError(1e-13)
   {
      // Initilise framework
      FrameworkMacro::init();
    ...
    *
    * @param SphericalChebyshevFftTransformTest   Test fixture ID
    * @param MeshGrid                              Test ID
    */
   TEST_F(SphericalChebyshevFftTransformTest, MeshGrid)
   {
    ...
    */
   TEST_F(SphericalChebyshevFftTransformTest, ForwardRealAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN + 1;
    ...
    */
   TEST_F(SphericalChebyshevFftTransformTest, BackwardRealAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN + 1;
    ...
    *
    * @param SphericalChebyshevFftTransformTest
    * @param ForwardComplexAccuracy
    */
   TEST_F(SphericalChebyshevFftTransformTest, ForwardComplexAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN+1;
    ...
    */
   TEST_F(SphericalChebyshevFftTransformTest, BackwardComplexAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN + 1;
