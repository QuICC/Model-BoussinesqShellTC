/** 
 * @file CylindricalChebyshevFftTransformTest.cpp
...
namespace TestSuite {
    ...
    */
   class CylindricalChebyshevFftTransformTest : public ::testing::Test {
      public:
      ...
      protected:
          ...
          * @brief Constructor
          */
         CylindricalChebyshevFftTransformTest();

         /**
          * @brief Destructor
          */
         virtual ~CylindricalChebyshevFftTransformTest();
   ...
   CylindricalChebyshevFftTransformTest::CylindricalChebyshevFftTransformTest()
      : mError(1e-13)
   {
      // Initilise framework
      FrameworkMacro::init();
    ...
    *
    * @param CylindricalChebyshevFftTransformTest Test fixture ID
    * @param MeshGrid                              Test ID
    */
   TEST_F(CylindricalChebyshevFftTransformTest, MeshGrid)
   {
    ...
    */
   TEST_F(CylindricalChebyshevFftTransformTest, ForwardRealAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN + 1;
    ...
    */
   TEST_F(CylindricalChebyshevFftTransformTest, BackwardRealAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN + 1;
    ...
    */
   TEST_F(CylindricalChebyshevFftTransformTest, ForwardComplexAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN+1;
    ...
    */
   TEST_F(CylindricalChebyshevFftTransformTest, BackwardComplexAccuracy)
   {
      // Set spectral and physical sizes
      int maxN = 11;
      int nN = maxN + 1;
