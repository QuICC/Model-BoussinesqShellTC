...
namespace Transform {
   ...
   class ParityTransformTools
   {
      public:
         ...
         /**
          * @brief Check regularity
          */
         static void checkRegularity(const Matrix& data, const int rows);
         
         /**
          * @brief Correct regularity error
          */
         static void correctRegularity(Matrix& rData, const int rows);
