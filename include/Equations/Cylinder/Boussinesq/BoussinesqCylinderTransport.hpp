...
namespace Equations {
    ...
    */
   void timeBlock(const BoussinesqCylinderTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs);
    ...
    * @param eigs    Harmonic degree l and harmonic order m
    */
   void linearBlock(const BoussinesqCylinderTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs);
