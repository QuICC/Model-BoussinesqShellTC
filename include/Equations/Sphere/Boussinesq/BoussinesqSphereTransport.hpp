...
namespace Equations {
    ...
    */
   void timeBlock(const BoussinesqSphereTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs);
    ...
    * @param eigs    Harmonic degree l and harmonic order m
    */
   void linearBlock(const BoussinesqSphereTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs);
