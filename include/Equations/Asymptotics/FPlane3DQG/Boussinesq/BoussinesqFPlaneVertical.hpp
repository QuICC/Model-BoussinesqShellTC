...
namespace Equations {
    ...
    */
   void quasiInverseBlock(const BoussinesqFPlaneVertical& eq, SparseMatrix& mat);
    ...
    */
   void timeBlock(const BoussinesqFPlaneVertical& eq, DecoupledZSparse& mat, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const BoussinesqFPlaneVertical& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const BoussinesqFPlaneVertical& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
