...
namespace Equations {
    ...
    */
   void quasiInverseBlock(const AnelasticFPlaneTransport& eq, SparseMatrix& mat);
    ...
    */
   void timeBlock(const AnelasticFPlaneTransport& eq, DecoupledZSparse& mat, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const AnelasticFPlaneTransport& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const AnelasticFPlaneTransport& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
