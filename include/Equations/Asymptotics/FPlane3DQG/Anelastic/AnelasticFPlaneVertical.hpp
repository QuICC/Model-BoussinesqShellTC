...
#define ANELASTICFPLANEVERTICAL_HPP
...
namespace Equations {
    ...
    * @brief Implementation of the vertical velocity equation for the anelastic 3DQG f-plane model
    */
   class AnelasticFPlaneVertical: public IScalarEquation
   {
      public:
         /**
          ...
          */
         AnelasticFPlaneVertical(SharedEquationParameters spEqParams);

         /**
          * @brief Simple empty destructor
          */
         virtual ~AnelasticFPlaneVertical();
    ...
    */
   void quasiInverseBlock(const AnelasticFPlaneVertical& eq, FieldComponents::Spectral::Id compId, SparseMatrix& mat);
    ...
    */
   void timeBlock(const AnelasticFPlaneVertical& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const AnelasticFPlaneVertical& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const AnelasticFPlaneVertical& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);

}
}

#endif // ANELASTICFPLANEVERTICAL_HPP
