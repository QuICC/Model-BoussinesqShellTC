...
namespace Equations {
    ...
    */
   void quasiInverseBlock(const AnelasticFPlaneVertical& eq, SparseMatrix& mat);
    ...
    */
   void timeBlock(const AnelasticFPlaneVertical& eq, DecoupledZSparse& mat, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const AnelasticFPlaneVertical& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const AnelasticFPlaneVertical& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
