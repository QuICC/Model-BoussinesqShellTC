...
namespace Equations {
    ...
    */
   void quasiInverseBlock(const AnelasticBetaCylGTransport& eq, FieldComponents::Spectral::Id compId, SparseMatrix& mat);
    ...
    */
   void timeBlock(const AnelasticBetaCylGTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const AnelasticBetaCylGTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const AnelasticBetaCylGTransport& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
