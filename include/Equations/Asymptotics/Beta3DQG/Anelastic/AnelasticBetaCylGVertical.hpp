...
namespace Equations {
    ...
    */
   void quasiInverseBlock(const AnelasticBetaCylGVertical& eq, SparseMatrix& mat);
    ...
    */
   void timeBlock(const AnelasticBetaCylGVertical& eq, DecoupledZSparse& mat, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const AnelasticBetaCylGVertical& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const AnelasticBetaCylGVertical& eq, DecoupledZSparse& mat, const SpectralFieldId fieldId, const MHDFloat k);
