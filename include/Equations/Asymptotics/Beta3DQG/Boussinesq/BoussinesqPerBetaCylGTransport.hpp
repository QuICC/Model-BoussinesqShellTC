...
namespace Equations {
   ...
   class BoussinesqPerPerBetaCylGTransport: public IScalarEquation
   {
      public:
          ...
          */
         BoussinesqPerPerBetaCylGTransport(SharedEquationParameters spEqParams);

         /**
          * @brief Simple empty destructor
          */
         virtual ~BoussinesqPerPerBetaCylGTransport();
    ...
    */
   void timeBlock(const BoussinesqPerBetaCylGStreamfunction& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const int nX, const int nZ, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void linearBlock(const BoussinesqPerBetaCylGStreamfunction& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const int nX, const int nZ, const MHDFloat k);
    ...
    * @param k       Wave number k
    */
   void boundaryBlock(const BoussinesqPerBetaCylGStreamfunction& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const int nX, const int nZ, const MHDFloat k);
