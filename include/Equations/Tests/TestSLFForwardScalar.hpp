/**
 * @file TestSLFForwardScalar.hpp
 * @brief Implementation of a test equation for the SLF scheme with exact known physical space scalar solution
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef TESTSLFFORWARDSCALAR_HPP
#define TESTSLFFORWARDSCALAR_HPP
...
namespace Equations {
    ...
    * @brief Implementation of a test equation for the SLF scheme with exact known physical space scalar solution
    */
   class TestSLFForwardScalar: public IScalarEquation
   {
      public:
         /**
          ...
          * @brief Constructor
          */
         TestSLFForwardScalar();

         /**
          * @brief Destructor
          */
         virtual ~TestSLFForwardScalar();
          ...
          */
         void setSolutionType(const TestSLFForwardScalar::SolutionTypeId id);
   ...
   /// Typedef for a shared TestSLFForwardScalar
   typedef SharedPtrMacro<TestSLFForwardScalar> SharedTestSLFForwardScalar;

}
}

#endif // TESTSLFFORWARDSCALAR_HPP
