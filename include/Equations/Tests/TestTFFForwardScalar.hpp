/**
 * @file TestTFFForwardScalar.hpp
 * @brief Implementation of a test equation for the TFF scheme with exact known physical space scalar solution
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef TESTTFFFORWARDSCALAR_HPP
#define TESTTFFFORWARDSCALAR_HPP
...
namespace Equations {
    ...
    * @brief Implementation of a test equation for the TFF scheme with exact known physical space scalar solution
    */
   class TestTFFForwardScalar: public IScalarEquation
   {
      public:
         /**
          ...
          * @brief Constructor
          */
         TestTFFForwardScalar();

         /**
          * @brief Destructor
          */
         virtual ~TestTFFForwardScalar();
          ...
          */
         void setSolutionType(const TestTFFForwardScalar::SolutionTypeId id);
   ...
   /// Typedef for a shared TestTFFForwardScalar
   typedef SharedPtrMacro<TestTFFForwardScalar> SharedTestTFFForwardScalar;

}
}

#endif // TESTTFFFORWARDSCALAR_HPP
