...
namespace Equations {
    ...
    * @brief Implementation of a test equation for the TFT scheme with exact known physical space scalar solution
    */
   class TestTFTForwardScalar: public IScalarEquation
   {
      public:
         /**
          ...
          * @brief Constructor
          */
         TestTFTForwardScalar();

         /**
          * @brief Destructor
          */
         virtual ~TestTFTForwardScalar();
          ...
          */
         void setSolutionType(const TestTFTForwardScalar::SolutionTypeId id);
   ...
   /// Typedef for a shared TestTFTForwardScalar
   typedef SharedPtrMacro<TestTFTForwardScalar> SharedTestTFTForwardScalar;

}
}

#endif // TESTTFTFORWARDSCALAR_HPP
