/**
 * @file TestFFFForwardScalar.hpp
 * @brief Implementation of a test equation for the FFF scheme with exact known physical space scalar solution
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef TESTFFFFORWARDSCALAR_HPP
#define TESTFFFFORWARDSCALAR_HPP
...
namespace Equations {
    ...
    * @brief Implementation of a test equation for the FFF scheme with exact known physical space scalar solution
    */
   class TestFFFForwardScalar: public IScalarEquation
   {
      public:
         /**
          ...
          * @brief Constructor
          */
         TestFFFForwardScalar();

         /**
          * @brief Destructor
          */
         virtual ~TestFFFForwardScalar();
          ...
          */
         void setSolutionType(const TestFFFForwardScalar::SolutionTypeId id);
   ...
   /// Typedef for a shared TestFFFForwardScalar
   typedef SharedPtrMacro<TestFFFForwardScalar> SharedTestFFFForwardScalar;

}
}

#endif // TESTFFFFORWARDSCALAR_HPP
