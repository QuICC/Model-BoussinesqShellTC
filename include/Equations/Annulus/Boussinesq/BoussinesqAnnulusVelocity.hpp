...
namespace Equations {
    ...
    */
   void timeBlock(const BoussinesqAnnulusVelocity& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs);
    ...
    * @param eigs    Harmonic degree l and harmonic order m
    */
   void linearBlock(const BoussinesqAnnulusVelocity& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs);
