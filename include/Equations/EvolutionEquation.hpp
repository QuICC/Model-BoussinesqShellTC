...
namespace GeoMHDiSCC {
   ...
   class EvolutionEquation
   {
      public:
          ...
          */
         EvolutionEquation(SharedEquationParameters spEqParams);

         /**
          * @brief Simple empty destructor
          */
         virtual ~EvolutionEquation();
   ...
   inline void EvolutionEquation::setField(PhysicalNames::Id name, Code::SharedScalarVariable spField)
   {
      this->mScalars.insert(std::make_pair(name, spField));
   }

   inline void EvolutionEquation::setField(PhysicalNames::Id name, Code::SharedVectorVariable spField)
   {
      this->mVectors.insert(std::make_pair(name, spField));
   }

   inline const Code::ScalarVariable& EvolutionEquation::scalar(PhysicalNames::Id name) const
   {
      // Safety assertion
   ...
   inline Code::ScalarVariable& EvolutionEquation::rScalar(PhysicalNames::Id name)
   {
      // Safety assertion
      assert(this->mScalars.count(name) == 1);
   ...
   inline const Code::VectorVariable& EvolutionEquation::vector(PhysicalNames::Id name) const
   {
      // Safety assertion
   ...
   inline Code::VectorVariable& EvolutionEquation::rVector(PhysicalNames::Id name)
   {
      // Safety assertion
      assert(this->mVectors.count(name) == 1);
   ...
   inline const EquationParameters& EvolutionEquation::eqParams() const
   {
      return *this->mspEqParams;
   }

   inline const std::map<BoundaryConditions::Id,BoundaryConditions::Position>& EvolutionEquation::getBCs(FieldComponents::Spectral::Component id, Dimensions::Type dim) const
   {
      // Safety assert
   ...
   inline const std::map<BoundaryConditions::Id,BoundaryConditions::Position>& EvolutionEquation::getCBCs(FieldComponents::Spectral::Component id, Dimensions::Type dim) const
   {
      // Safety assert
   ...
   inline const std::map<BoundaryConditions::Id,ArrayZ>& EvolutionEquation::getBVals(FieldComponents::Spectral::Component id, Dimensions::Type dim) const
   {
      // Safety assert
   ...
   inline const DecoupledZSparse& EvolutionEquation::timeMatrix(FieldComponents::Spectral::Component id, const int j) const
   {
      // Safety assert
   ...
   inline const DecoupledZSparse& EvolutionEquation::linearMatrix(FieldComponents::Spectral::Component id, const int j) const
   {
      // Safety assert
   ...
   inline const DecoupledZSparse& EvolutionEquation::couplingMatrix(FieldComponents::Spectral::Component id, const int j) const
   {
      // Safety assert
   ...
   inline const DecoupledZSparse& EvolutionEquation::bcMatrix(FieldComponents::Spectral::Component id, const int j) const
   {
      // Safety assert
   ...
   inline const DecoupledZSparse& EvolutionEquation::cbcMatrix(FieldComponents::Spectral::Component id, const int j) const
   {
      // Safety assert
   ...
   inline const CouplingInformation& EvolutionEquation::couplingInfo() const
   {
      return this->mCouplingInfo;
   }

   inline PhysicalNames::Id   EvolutionEquation::name() const
   {
      return this->mName;
   }

   inline const std::map<PhysicalNames::Id, std::pair<bool, TriBool> >&  EvolutionEquation::requirements() const
   {
      return this->mRequirements;
   }

   inline TriBool EvolutionEquation::requirements(PhysicalNames::Id name) const
   {
   ...
   /// Typedef for a smart EvolutionEquation
   typedef SharedPtrMacro<EvolutionEquation> SharedEvolutionEquation;
}

#endif // EVOLUTIONEQUATION_HPP
