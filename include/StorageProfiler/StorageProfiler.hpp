...
namespace Debug {
   ...
   class StorageProfiler
   {
      public:
          ...
          */
         enum StoragePoint {VARIABLES, TRANSFORMS, TEMPORARIES, TRIVIALEQUATION, DIAGNOSTICEQUATION, PROGNOSTICEQUATION, MPI, IO, SCALAR1, SCALAR2, SCALAR3, VECTOR1, VECTOR2, VECTOR3, TRANSFORM1D, TRANSFORM2D, TRANSFORM3D, TRANSFORM1DTEMP, TRANSFORM2DTEMP, TRANSFORM3DTEMP, MPIBUFFERS, MPITYPES, MPICOMM, NMAXSTORAGEPOINT};
