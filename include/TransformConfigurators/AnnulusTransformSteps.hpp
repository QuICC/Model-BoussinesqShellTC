/** 
 * @file AnnulusTransformSteps.hpp
 * @brief Definition of some useful enums for the steps involved in the physical <-> spectral transforms in a cylindrical annulus
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef ANNULUSTRANSFORMSTEPS_HPP
#define ANNULUSTRANSFORMSTEPS_HPP
...
namespace GeoMHDiSCC {
   ...
   namespace Transform {
      ...
      /**
       * @brief Struct to contain the steps involved in a the physical <-> spectral transforms in a cylindrical annulus
       */
...
#endif // ANNULUSTRANSFORMSTEPS_HPP
