...
namespace Transform {
   ...
   class ForwardSerialConfigurator: public ForwardConfigurator
   {
      public:
          ...
          */
         static void firstStep(const IntegratorTree& tree, Equations::SharedIScalarEquation spEquation, TransformCoordinatorType& coord);
          ...
          * @param coord      Transform coordinator
          */
         static void firstStep(const IntegratorTree& tree, Equations::SharedIVectorEquation spEquation, TransformCoordinatorType& coord);
          ...
          * @param coord      Transform coordinator
          */
         static void secondStep(const IntegratorTree& tree, Equations::SharedIScalarEquation spEquation, TransformCoordinatorType& coord);
          ...
          * @param coord      Transform coordinator
          */
         static void secondStep(const IntegratorTree& tree, Equations::SharedIVectorEquation spEquation, TransformCoordinatorType& coord);
          ...
          * @param coord      Transform coordinator
          */
         static void lastStep(const IntegratorTree& tree, Equations::SharedIScalarEquation spEquation, TransformCoordinatorType& coord);
          ...
          * @param coord      Transform coordinator
          */
         static void lastStep(const IntegratorTree& tree, Equations::SharedIVectorEquation spEquation, TransformCoordinatorType& coord);
