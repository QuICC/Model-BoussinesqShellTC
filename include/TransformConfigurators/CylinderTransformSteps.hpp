 ...
 * @brief Definition of some useful enums for steps involved in the physical <-> spectral transforms in a whole cylinder
...
namespace GeoMHDiSCC {
   ...
   namespace Transform {
      ...
      /**
       * @brief Struct to contain the steps involved in the physical <-> spectral transforms in a whole cylinder
       */
