/** 
 * @file ImExRKCB3d.hpp
 * @brief Implementation of an implicit/explicit Runge-Kutta scheme of order 3d (Cavaglieri & Bewley, 2015)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef IMEXRKCB3D_HPP
#define IMEXRKCB3D_HPP
