/** 
 * @file ImExRKCB3b.hpp
 * @brief Implementation of an implicit/explicit Runge-Kutta scheme of order 3b (Cavaglieri & Bewley, 2015)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef IMEXRKCB3B_HPP
#define IMEXRKCB3B_HPP
