...
namespace QuICC {
    ...
    * @brief Implementation of spherical harmonic index counter with l spectral ordering
    */ 
   class SHlIndexCounter: public IndexCounter
   {
      public:
         /**
          * @brief Constructor
          */
         SHlIndexCounter(SharedCSimulationResolution spSim, SharedCCoreResolution spCpu);
   ...
   /// Typedef for an smart reference counting pointer for a SHlIndexCounter
   typedef SharedPtrMacro<SHlIndexCounter>   SharedSHlIndexCounter;

}

#endif // SHLINDEXCOUNTER_HPP
