...
namespace Physical {
    ...
    * @brief Implementation of a generic streamfunction advection
    */
   template <FieldComponents::Physical::Id TXComp = FieldComponents::Physical::ONE, FieldComponents::Physical::Id TYComp = FieldComponents::Physical::TWO> class StreamAdvection
   {
      public:
         /**
   ...
   template <FieldComponents::Physical::Id TXComp, FieldComponents::Physical::Id TYComp> template <int COMPONENTS> void StreamAdvection<TXComp,TYComp>::add(Datatypes::PhysicalScalarType &rS, const Datatypes::VectorField<Datatypes::PhysicalScalarType, COMPONENTS, FieldComponents::Physical::Id> &dPsi, const Datatypes::VectorField<Datatypes::PhysicalScalarType, COMPONENTS, FieldComponents::Physical::Id> &w, const MHDFloat c)
   {
      if(c != 1.0)
      {
   ...
   template <FieldComponents::Physical::Id TXComp, FieldComponents::Physical::Id TYComp> template <int COMPONENTS> void StreamAdvection<TXComp,TYComp>::sub(Datatypes::PhysicalScalarType &rS, const Datatypes::VectorField<Datatypes::PhysicalScalarType, COMPONENTS, FieldComponents::Physical::Id> &dPsi, const Datatypes::VectorField<Datatypes::PhysicalScalarType, COMPONENTS, FieldComponents::Physical::Id> &w, const MHDFloat c)
   {
      if(c != 1.0)
      {
