...
namespace Physical {
   ...
   template <FieldComponents::Physical::Id TONE, FieldComponents::Physical::Id TTWO> void VelocityAdvection<TONE,TTWO,FieldComponents::Physical::NOTUSED>::set(Datatypes::PhysicalScalarType &rS, const Datatypes::VectorField<Datatypes::PhysicalScalarType, FieldComponents::Physical::Id> &u, const Datatypes::VectorField<Datatypes::PhysicalScalarType, FieldComponents::Physical::Id> &gradQ, const MHDFloat c)
   {
      if(c != 1.0)
      {
         rS.setData(c*(u.comp(TONE).data().array()*gradQ.comp(TONE).data().array()).matrix());
   ...
   template <FieldComponents::Physical::Id TONE, FieldComponents::Physical::Id TTWO> void VelocityAdvection<TONE,TTWO,FieldComponents::Physical::NOTUSED>::add(Datatypes::PhysicalScalarType &rS, const Datatypes::VectorField<Datatypes::PhysicalScalarType, FieldComponents::Physical::Id> &u, const Datatypes::VectorField<Datatypes::PhysicalScalarType, FieldComponents::Physical::Id> &gradQ, const MHDFloat c)
   {
      if(c != 1.0)
      {
         rS.addData(c*(u.comp(TONE).data().array()*gradQ.comp(TONE).data().array()).matrix());
   ...
   template <FieldComponents::Physical::Id TONE, FieldComponents::Physical::Id TTWO> void VelocityAdvection<TONE,TTWO,FieldComponents::Physical::NOTUSED>::sub(Datatypes::PhysicalScalarType &rS, const Datatypes::VectorField<Datatypes::PhysicalScalarType, FieldComponents::Physical::Id> &u, const Datatypes::VectorField<Datatypes::PhysicalScalarType, FieldComponents::Physical::Id> &gradQ, const MHDFloat c)
   {
      if(c != 1.0)
      {
         rS.subData(c*(u.comp(TONE).data().array()*gradQ.comp(TONE).data().array()).matrix());
