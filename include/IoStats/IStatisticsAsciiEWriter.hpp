/** 
 * @file IStatisticsAsciiEWriter.hpp
 * @brief Implementation of a generic variable to ASCII file writer
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef ISTATISTICSASCIIEWRITER_HPP
#define ISTATISTICSASCIIEWRITER_HPP
...
namespace IoStats {
   ...
   class IStatisticsAsciiEWriter: public IoAscii::IAsciiWriter
   {
      public:
          ...
          */
         IStatisticsAsciiEWriter(std::string name, std::string ext, std::string header, std::string type, std::string version, const Dimensions::Space::Id id);

         /**
          * @brief Destructor
          */
         virtual ~IStatisticsAsciiEWriter();
   ...
   typedef SharedPtrMacro<IStatisticsAsciiEWriter>   SharedIStatisticsAsciiEWriter;

   inline bool IStatisticsAsciiEWriter::isHeavy() const
   {
      return false;
   }
...
#endif // ISTATISTICSASCIIEWRITER_HPP
