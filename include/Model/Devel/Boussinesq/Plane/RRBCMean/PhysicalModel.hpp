/** 
 * @file BoussinesqRRBCPlaneMeanModel.hpp
...
#ifndef BOUSSINESQRRBCPLANEMEANMODEL_HPP
#define BOUSSINESQRRBCPLANEMEANMODEL_HPP
...
namespace QuICC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard in a plane layer (toroidal/poloidal formulation) with anisotropic rescaling model
    */
   class BoussinesqRRBCPlaneMeanModel
   {
      public:
...
#endif // BOUSSINESQRRBCPLANEMEANMODEL_HPP
