...
namespace QuICC {
    ...
    * @brief Implementation of the Boussinesq Rayleigh-Benard in a plane layer (velocity-continuity formulation) model
    */
   class BoussinesqRBCPlaneVCModel
   {
      public:
...
#endif // BOUSSINESQRBCPLANEVCMODEL_HPP
