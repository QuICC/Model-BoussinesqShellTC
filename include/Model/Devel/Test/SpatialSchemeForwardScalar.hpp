/**
 * @file SpatialSchemeForwardScalar.hpp
...
namespace Test {
    ...
    * @brief Implementation of a test equation for the spatial schemes with exact known physical space scalar solution
    */
   class SpatialSchemeForwardScalar: public IScalarEquation
   {
      public:
         /**
          ...
          * @brief Constructor
          */
         SpatialSchemeForwardScalar();

         /**
          * @brief Destructor
          */
         virtual ~SpatialSchemeForwardScalar();
          ...
          */
         void setSolutionType(const SpatialSchemeForwardScalar::SolutionTypeId id);
   ...
   /// Typedef for a shared SpatialSchemeForwardScalar
   typedef SharedPtrMacro<SpatialSchemeForwardScalar> SharedSpatialSchemeForwardScalar;
