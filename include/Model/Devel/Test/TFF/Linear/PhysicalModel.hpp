 ...
 * @brief Implementation of test model for the TFF scheme
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef QUICC_MODEL_TEST_TFF_LINEAR_PHYSICALMODEL_HPP
#define QUICC_MODEL_TEST_TFF_LINEAR_PHYSICALMODEL_HPP
...
namespace Linear {
   ...
   /**
    * @brief Implementation of test mode equation for the TFF scheme
    */
   class PhysicalModel
   {
      public:
...
#endif // QUICC_MODEL_TEST_TFF_LINEAR_PHYSICALMODEL_HPP
