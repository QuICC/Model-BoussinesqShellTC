 ...
 * @brief Implementation of test model for the AFT scheme
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef QUICC_MODEL_TEST_AFT_LINEAR_PHYSICALMODEL_HPP
#define QUICC_MODEL_TEST_AFT_LINEAR_PHYSICALMODEL_HPP
...
namespace Linear {
   ...
   /**
    * @brief Implementation of test model equation for the AFT scheme
    */
   class PhysicalModel
   {
      public:
...
#endif // QUICC_MODEL_TEST_AFT_LINEAR_PHYSICALMODEL_HPP
