/**
 * @file DissV.hpp
 * @brief Implementation of the local viscous dissipation for the Boussinesq F-plane 3DQG model 
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef QUICC_EQUATIONS_BOUSSINESQ_PLANE_QGMHDBHH_DISSV_HPP
#define QUICC_EQUATIONS_BOUSSINESQ_PLANE_QGMHDBHH_DISSV_HPP
...
#endif // QUICC_EQUATIONS_BOUSSINESQ_PLANE_QGMHDBHH_DISSV_HPP
