...
namespace Debug {
   ...
   class ProfilerBase
   {
      public:
          ...
          */
         enum BreakPoint {BWDTRANSFORM, NONLINEAR, FWDTRANSFORM, LINEAR, TIMESTEP, CONTROL, IO, BWD1D, BWD2D, BWD3D, FWD1D, FWD2D, FWD3D, FWDCONVSEND, BWDCONVSEND, FWDCONVRECV, BWDCONVRECV};
