/** 
 * @file Cartesian1DKineticCartesianWriter.hpp
...
#ifndef CARTESIAN1DKINETICCARTESIANWRITER_HPP
#define CARTESIAN1DKINETICCARTESIANWRITER_HPP
...
namespace IoVariable {
    ...
    * @brief Implementation of the ASCII Cartesian 1D (double periodic)energy calculation for a vector field (streamfunction formulation)
    */
   class Cartesian1DKineticCartesianWriter: public IVariableAsciiEWriter
   {
      public:
         /**
          ...
          */
         Cartesian1DKineticCartesianWriter(const std::string& prefix, const std::string& type, const bool hasZonalX = false, const bool hasZonalY = false);

         /**
          * @brief Destructor
          */
         virtual ~Cartesian1DKineticCartesianWriter();
   ...
   inline bool Cartesian1DKineticCartesianWriter::isHeavy() const
   {
      return true;
   }

   /// Typedef for a shared pointer of a HDF5 state file writer
   typedef SharedPtrMacro<Cartesian1DKineticCartesianWriter> SharedCartesian1DKineticCartesianWriter;

}
}

#endif // CARTESIAN1DKINETICCARTESIANWRITER_HPP
