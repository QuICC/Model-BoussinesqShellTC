/** 
 * @file Cartesian1DFluctuatingMagneticEnergyWriter.hpp
...
#ifndef CARTESIAN1DFLUCTUATINGMAGNETICENERGYWRITER_HPP
#define CARTESIAN1DFLUCTUATINGMAGNETICENERGYWRITER_HPP
...
namespace IoVariable {
    ...
    * @brief Implementation of the ASCII Cartesian 1D (double periodic)energy calculation for a vector field (streamfunction formulation)
    */
   class Cartesian1DFluctuatingMagneticEnergyWriter: public IVariableAsciiEWriter
   {
      public:
         /**
          ...
          */
         Cartesian1DFluctuatingMagneticEnergyWriter(const std::string& prefix, const std::string& type, const bool hasZonalX = false, const bool hasZonalY = false);

         /**
          * @brief Destructor
          */
         virtual ~Cartesian1DFluctuatingMagneticEnergyWriter();
   ...
   inline bool Cartesian1DFluctuatingMagneticEnergyWriter::isHeavy() const
   {
      return true;
   }

   /// Typedef for a shared pointer of a HDF5 state file writer
   typedef SharedPtrMacro<Cartesian1DFluctuatingMagneticEnergyWriter> SharedCartesian1DFluctuatingMagneticEnergyWriter;

}
}

#endif // CARTESIAN1DFLUCTUATINGMAGNETICENERGYWRITER_HPP
