/** 
 * @file SparseZCoordinatorBase.hpp
 * @brief Implementation of the base for a complex field sparse solver coordinator
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef SPARSEZCOORDINATORBASE_HPP
#define SPARSEZCOORDINATORBASE_HPP
...
namespace Solver {
    ...
    * @brief Implementation of the base for a complex field sparse solver coordinator
    */
   template <template <class,class> class TSolver> class SparseCoordinatorBase<TSolver,true>
   {
      public:
   ...
   template <template <class,class> class TSolver> SparseCoordinatorBase<TSolver,true>::SparseCoordinatorBase()
      : mNStep(1), mStep(0)
   {
   }
   ...
   template <template <class,class> class TSolver> bool SparseCoordinatorBase<TSolver,true>::finishedStep() const
   {
      return (this->mStep == 0);
   }

   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::addRZSolver(const int start)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::addZZSolver(const int start)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::createSolver(Equations::SharedIEquation spEq, FieldComponents::Spectral::Id comp)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::createStorage(Equations::SharedIEquation spEq, FieldComponents::Spectral::Id comp)
   {
   ...
   template <template <class,class> class TSolver> template <typename TSolverIt> void SparseCoordinatorBase<TSolver,true>::setupStorage(Equations::SharedIEquation spEq, const SpectralFieldId id, const TSolverIt solveIt)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::transferOutput(const ScalarEquation_range& scalEq, const VectorEquation_range& vectEq)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::initSolution(const ScalarEquation_range& scalEq, const VectorEquation_range& vectEq)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,true>::getInput(const ScalarEquation_range& scalEq, const VectorEquation_range& vectEq, const ScalarVariable_map& scalVar, const VectorVariable_map& vectVar)
   {
      // Storage for information and identity
      SpectralFieldId myId;
   ...
   template <template <class,class> class TSolver> template <typename TEquationIt, typename TSolverIt> void SparseCoordinatorBase<TSolver,true>::getSolverInput(const TEquationIt eqIt, const SpectralFieldId id, const TSolverIt solveIt, const ScalarVariable_map& scalVar, const VectorVariable_map& vectVar)
   {
      // Get timestep input
...
#endif // SPARSEZCOORDINATORBASE_HPP
