/** 
 * @file SparseRCoordinatorBase.hpp
 * @brief Implementation of the base for a real field sparse solver coordinator
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef SPARSERCOORDINATORBASE_HPP
#define SPARSERCOORDINATORBASE_HPP
...
namespace Solver {
    ...
    */
   template <template <class,class> class TSolver> class SparseCoordinatorBase<TSolver,false>
   {
      public:
   ...
   template <template <class,class> class TSolver> SparseCoordinatorBase<TSolver,false>::SparseCoordinatorBase()
      : mNStep(1), mStep(0)
   {
   }
   ...
   template <template <class,class> class TSolver> bool SparseCoordinatorBase<TSolver,false>::finishedStep() const
   {
      return (this->mStep == 0);
   }

   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,false>::addRRSolver(const int start)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,false>::createSolver(Equations::SharedIEquation spEq, FieldComponents::Spectral::Id comp)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,false>::createStorage(Equations::SharedIEquation spEq, FieldComponents::Spectral::Id comp)
   {
   ...
   template <template <class,class> class TSolver> template <typename TSolverIt> void SparseCoordinatorBase<TSolver,false>::setupStorage(Equations::SharedIEquation spEq, const SpectralFieldId id, const TSolverIt solveIt)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,false>::transferOutput(const ScalarEquation_range& scalEq, const VectorEquation_range& vectEq)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,false>::initSolution(const ScalarEquation_range& scalEq, const VectorEquation_range& vectEq)
   {
   ...
   template <template <class,class> class TSolver> void SparseCoordinatorBase<TSolver,false>::getInput(const ScalarEquation_range& scalEq, const VectorEquation_range& vectEq, const ScalarVariable_map& scalVar, const VectorVariable_map& vectVar)
   {
      // Storage for information and identity
      SpectralFieldId myId;
   ...
   template <template <class,class> class TSolver> template <typename TEquationIt, typename TSolverIt> void SparseCoordinatorBase<TSolver,false>::getSolverInput(const TEquationIt eqIt, const SpectralFieldId id, const TSolverIt solveIt, const ScalarVariable_map& scalVar, const VectorVariable_map& vectVar)
   {
      // Get timestep input
...
#endif // SPARSERCOORDINATORBASE_HPP
