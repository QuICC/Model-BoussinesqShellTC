/** 
 * @file BoussinesqNC3DBoxVCModel.hpp
 * @brief Implementation of the Boussinesq natural convection in 3D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQNC3DBOXVCMODEL_HPP
#define BOUSSINESQNC3DBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq natural convection in 3D box (velocity-continuity formulation) model
    */
   class BoussinesqNC3DBoxVCModel
   {
      public:
...
#endif // BOUSSINESQNC3DBOXVCMODEL_HPP
