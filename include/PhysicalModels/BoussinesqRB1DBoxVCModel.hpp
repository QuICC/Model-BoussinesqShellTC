/** 
 * @file BoussinesqRB1DBoxVCModel.hpp
 * @brief Implementation of the Boussinesq Rayleigh-Benard 1D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRB1DBOXVCMODEL_HPP
#define BOUSSINESQRB1DBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq Rayleigh-Benard 1D box (velocity-continuity formulation) model
    */
   class BoussinesqRB1DBoxVCModel
   {
      public:
...
#endif // BOUSSINESQRB1DBOXVCMODEL_HPP
