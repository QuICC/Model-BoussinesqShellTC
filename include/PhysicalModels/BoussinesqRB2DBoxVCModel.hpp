/** 
 * @file BoussinesqRB2DBoxVCModel.hpp
 * @brief Implementation of the Boussinesq Rayleigh-Benard 2D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRB2DBOXVCMODEL_HPP
#define BOUSSINESQRB2DBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq Rayleigh-Benard 2D box (velocity-continuity formulation) model
    */
   class BoussinesqRB2DBoxVCModel
   {
      public:
...
#endif // BOUSSINESQRB2DBOXVCMODEL_HPP
