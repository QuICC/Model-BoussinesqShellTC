...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq Rayleigh-Benard in a square cavity (2D) (streamfunction formulation) model
    */
   class BoussinesqRBCSquareSModel
   {
      public:
...
#endif // BOUSSINESQRBCSQUARESMODEL_HPP
