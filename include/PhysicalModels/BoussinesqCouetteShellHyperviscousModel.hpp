/** 
 * @file BoussinesqCouetteShellHyperviscousModel.hpp
...
#ifndef BoussinesqCouetteShellHyperviscousModel_HPP
#define BoussinesqCouetteShellHyperviscousModel_HPP
...
namespace QuICC {
    ...
    * @brief Implementation of the Boussinesq spherical Couette in a spherical shell (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
    */
   class BoussinesqCouetteShellHyperviscousModel
   {
      public:
      ...
      private:
          ...
          * @brief Constructor
          */
         BoussinesqCouetteShellHyperviscousModel();
...
#endif // BoussinesqCouetteShellHyperviscousModel_HPP
