/** 
 * @file BoussinesqRRBCPlaneVCModel.hpp
 * @brief Implementation of the Boussinesq rotating Rayleigh-Benard in a plane layer (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRRBCPLANEVCMODEL_HPP
#define BOUSSINESQRRBCPLANEVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard in a plane layer (velocity-continuity formulation) model
    */
   class BoussinesqRRBCPlaneVCModel
   {
      public:
...
#endif // BOUSSINESQRRBCPLANEVCMODEL_HPP
