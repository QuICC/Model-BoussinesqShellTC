/** 
 * @file BoussinesqDynamoPlaneModel.hpp
 * @brief Implementation of the Boussinesq rotating thermal dynamo in a plane layer (toroidal/poloidal formulation) with anisotropic rescaling model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQDYNAMOPLANEMODEL_HPP
#define BOUSSINESQDYNAMOPLANEMODEL_HPP
...
namespace QuICC {
    ...
    * @brief Implementation of the Boussinesq rotating thermal dynamo in a plane layer (toroidal/poloidal formulation) with anisotropic rescaling model
    */
   class BoussinesqDynamoPlaneModel
   {
      public:
...
#endif // BOUSSINESQDYNAMOPLANEMODEL_HPP
