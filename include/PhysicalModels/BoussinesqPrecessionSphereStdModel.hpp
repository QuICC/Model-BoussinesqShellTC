/** 
 * @file BoussinesqPrecessionSphereStdModel.hpp
 * @brief Implementation of the Boussinesq precession simulation in a sphere (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQPRECESSIONSPHERESTDMODEL_HPP
#define BOUSSINESQPRECESSIONSPHERESTDMODEL_HPP
...
namespace QuICC {
   ...
   /**
    * @brief Implementation of the Boussinesq precession simulation in a sphere model (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
    */
   class BoussinesqPrecessionSphereStdModel
   {
      public:
      ...
      private:
          ...
          * @brief Constructor
          */
         BoussinesqPrecessionSphereStdModel();
...
#endif // BOUSSINESQPRECESSIONSPHERESTDMODEL_HPP
