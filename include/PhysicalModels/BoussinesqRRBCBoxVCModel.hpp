/** 
 * @file BoussinesqRRBCBoxVCModel.hpp
 * @brief Implementation of the Boussinesq rotating Rayleigh-Benard in a 3D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRRBCBOXVCMODEL_HPP
#define BOUSSINESQRRBCBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard in a 3D box (velocity-continuity formulation) model
    */
   class BoussinesqRRBCBoxVCModel
   {
      public:
