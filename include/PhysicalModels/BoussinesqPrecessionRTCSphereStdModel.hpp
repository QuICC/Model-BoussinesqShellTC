/** 
 * @file BoussinesqPrecessionRTCSphereStdModel.hpp
 * @brief Implementation of the Boussinesq combined precession and rotating thermal convection in a sphere (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQPRECESSIONRTCSPHERESTDMODEL_HPP
#define BOUSSINESQPRECESSIONRTCSPHERESTDMODEL_HPP
...
namespace QuICC {
   ...
   /**
    * @brief Implementation of the Boussinesq combined precession and rotating thermal convection sphere model (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
    */
   class BoussinesqPrecessionRTCSphereStdModel
   {
      public:
      ...
      private:
          ...
          * @brief Constructor
          */
         BoussinesqPrecessionRTCSphereStdModel();
...
#endif // BOUSSINESQPRECESSIONRTCSPHERESTDMODEL_HPP
