/** 
 * @file BoussinesqRRB2DBoxVCModel.hpp
 * @brief Implementation of the Boussinesq rotating Rayleigh-Benard 2D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRRB2DBOXVCMODEL_HPP
#define BOUSSINESQRRB2DBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard 2D box (velocity-continuity formulation) model
    */
   class BoussinesqRRB2DBoxVCModel
   {
      public:
...
#endif // BOUSSINESQRRB2DBOXVCMODEL_HPP
