/** 
 * @file BoussinesqRRB1DBoxVCModel.hpp
 * @brief Implementation of the Boussinesq rotating Rayleigh-Benard 1D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRRB1DBOXVCMODEL_HPP
#define BOUSSINESQRRB1DBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard 1D box (velocity-continuity formulation) model
    */
   class BoussinesqRRB1DBoxVCModel
   {
      public:
...
#endif // BOUSSINESQRRB1DBOXVCMODEL_HPP
