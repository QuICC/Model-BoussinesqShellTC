/** 
 * @file BoussinesqRRB3DBoxVCModel.hpp
 * @brief Implementation of the Boussinesq rotating Rayleigh-Benard 3D box (velocity-continuity formulation) model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRRB3DBOXVCMODEL_HPP
#define BOUSSINESQRRB3DBOXVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard 3D box (velocity-continuity formulation) model
    */
   class BoussinesqRRB3DBoxVCModel
   {
      public:
...
#endif // BOUSSINESQRRB3DBOXVCMODEL_HPP
