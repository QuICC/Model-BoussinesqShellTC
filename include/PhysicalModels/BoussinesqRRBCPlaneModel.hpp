/** 
 * @file BoussinesqRRBCPlaneModel.hpp
...
#ifndef BOUSSINESQRRBCPLANEMODEL_HPP
#define BOUSSINESQRRBCPLANEMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of the Boussinesq rotating Rayleigh-Benard in a plane layer (toroidal/poloidal formulation) with anisotropic rescaling model
    */
   class BoussinesqRRBCPlaneModel
   {
      public:
...
#endif // BOUSSINESQRRBCPLANEMODEL_HPP
