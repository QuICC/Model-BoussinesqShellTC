...
#ifndef BOUSSINESQRRBCCYLINDERVCMODEL_HPP
#define BOUSSINESQRRBCCYLINDERVCMODEL_HPP
...
namespace GeoMHDiSCC {
   ...
   /**
    * @brief Implementation of Boussinesq rotating Rayleigh-Benard convection in a cylinder (velocity-continuity formulation) model
    */
   class BoussinesqRRBCCylinderVCModel
   {
      public:
...
#endif // BOUSSINESQRRBCCYLINDERVCMODEL_HPP
