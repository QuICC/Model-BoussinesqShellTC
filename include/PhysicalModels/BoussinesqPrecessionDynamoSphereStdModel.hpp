/** 
 * @file BoussinesqPrecessionDynamoSphereStdModel.hpp
 * @brief Implementation of the Boussinesq precession dynamo in a sphere model (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQPRECESSIONDYNAMOSPHERESTDMODEL_HPP
#define BOUSSINESQPRECESSIONDYNAMOSPHERESTDMODEL_HPP
...
namespace QuICC {
    ...
    * @brief Implementation of the Boussinesq precession dynamo in a sphere model (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
    */
   class BoussinesqPrecessionDynamoSphereStdModel
   {
      public:
      ...
      private:
          ...
          * @brief Constructor
          */
         BoussinesqPrecessionDynamoSphereStdModel();
...
#endif // BOUSSINESQPRECESSIONDYNAMOSPHERESTDMODEL_HPP
