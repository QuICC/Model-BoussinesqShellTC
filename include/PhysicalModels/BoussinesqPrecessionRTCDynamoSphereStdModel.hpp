/** 
 * @file BoussinesqPrecessionRTCDynamoSphereStdModel.hpp
 * @brief Implementation of the Boussinesq combined precession and thermal convection dynamo in a sphere model (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQPRECESSIONRTCDYNAMOSPHERESTDMODEL_HPP
#define BOUSSINESQPRECESSIONRTCDYNAMOSPHERESTDMODEL_HPP
...
namespace QuICC {
    ...
    * @brief Implementation of the Boussinesq combined precession and thermal convection dynamo in a sphere model (Toroidal/Poloidal formulation) without coupled solve (standard implementation)
    */
   class BoussinesqPrecessionRTCDynamoSphereStdModel
   {
      public:
      ...
      private:
          ...
          * @brief Constructor
          */
         BoussinesqPrecessionRTCDynamoSphereStdModel();
...
#endif // BOUSSINESQPRECESSIONRTCDYNAMOSPHERESTDMODEL_HPP
