/** 
 * @file BoussinesqAnnulusModel.hpp
 * @brief Implementation of the Boussinesq annulus model
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQANNULUSMODEL_HPP
#define BOUSSINESQANNULUSMODEL_HPP
...
#endif // BOUSSINESQANNULUSMODEL_HPP
