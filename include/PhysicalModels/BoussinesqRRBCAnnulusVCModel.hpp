/** 
 * @file BoussinesqRRBCAnnulusVCModel.hpp
 * @brief Implementation of Boussinesq rotating Rayleigh-Benard convection in a annulus (velocity-continuity formulation)
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef BOUSSINESQRRBCANNULUSVCMODEL_HPP
#define BOUSSINESQRRBCANNULUSVCMODEL_HPP
...
namespace GeoMHDiSCC {
    ...
    * @brief Implementation of Boussinesq rotating Rayleigh-Benard convection in a annulus (velocity-continuity formulation)
    */
   class BoussinesqRRBCAnnulusVCModel
   {
      public:
...
#endif // BOUSSINESQRRBCANNULUSVCMODEL_HPP
