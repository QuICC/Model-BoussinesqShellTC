/** 
 * @file SphereChebyshevOperator.hpp
 * @brief Implementation of the spectral operators for the chebyshev basis for a sphere radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef SPHERECHEBYSHEVOPERATOR_HPP
#define SPHERECHEBYSHEVOPERATOR_HPP
...
namespace Spectral {
    ...
    * @brief Implementation of the spectral operators for the chebyshev basis for a sphere radius
    */
   class SphereChebyshevOperator: public IOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         SphereChebyshevOperator(const int basisN);

         /**
          * @brief Empty Destructor
          */
         ~SphereChebyshevOperator();
...
#endif // SPHERECHEBYSHEVOPERATOR_HPP
