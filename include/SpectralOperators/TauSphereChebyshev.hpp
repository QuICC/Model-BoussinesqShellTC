/** 
 * @file TauSphereChebyshev.hpp
 * @brief Implementation of the Tau conditions for chebyshev based operators for a sphere radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef TAUSPHERECHEBYSHEV_HPP
#define TAUSPHERECHEBYSHEV_HPP
...
namespace Spectral {
    ...
    * @brief Implementation of the Tau conditions for chebyshev based operators for a sphere radius
    */
   class TauSphereChebyshev: public ITauBoundary
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         TauSphereChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq);
   ...
   template <typename TData> inline const TData& TauSphereChebyshev::extend(const TData& spec)
   {
      return spec;
   }

   template <typename TData> inline const TData& TauSphereChebyshev::restrict(const TData& spec)
   {
      return spec;
   }

   template <typename TData> void TauSphereChebyshev::constrainKronBlock(TData& mat)
   {
   }

   template <typename TData> bool TauSphereChebyshev::constrainKronProduct(TData& mat)
   {
   ...
   template <> inline bool TauSphereChebyshev::constrainKronProduct<SparseMatrixZ>(SparseMatrixZ& mat)
   {
      if(this->mIsComplex)
      {
         mat =  this->mZTau;
   ...
   template <> inline bool TauSphereChebyshev::constrainKronProduct<DecoupledZSparse>(DecoupledZSparse& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline bool TauSphereChebyshev::constrainKronProduct<SparseMatrix>(SparseMatrix& mat)
   {
      if(this->mIsComplex)
      {
