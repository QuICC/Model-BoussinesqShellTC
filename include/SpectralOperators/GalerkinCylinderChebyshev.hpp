/** 
 * @file GalerkinCylinderChebyshev.hpp
 * @brief Implementation of the Galerkin basis for chebyshev based operators for a cylinder radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef GALERKINCYLINDERCHEBYSHEV_HPP
#define GALERKINCYLINDERCHEBYSHEV_HPP
...
namespace Spectral {
    ...
    * @brief Implementation of the Galerkin basis for chebyshev based operators for a cylinder radius
    */
   class GalerkinCylinderChebyshev
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         GalerkinCylinderChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq);

         /**
          * @brief Empty Destructor
          */
         ~GalerkinCylinderChebyshev();
   ...
   template <typename TData> void GalerkinCylinderChebyshev::constrainKronBlock(TData& mat)
   {
      Debug::StaticAssert<false>();
   }

   template <typename TData> bool GalerkinCylinderChebyshev::constrainKronProduct(TData& mat)
   {
      return false;
   }

   template <typename TData> TData GalerkinCylinderChebyshev::extend(const TData& gal)
   {
      Debug::StaticAssert<false>();
   }

   template <> inline void GalerkinCylinderChebyshev::constrainKronBlock<SparseMatrixZ>(SparseMatrixZ& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline void GalerkinCylinderChebyshev::constrainKronBlock<DecoupledZSparse>(DecoupledZSparse& mat)
   {
   ...
   template <> inline void GalerkinCylinderChebyshev::constrainKronBlock<SparseMatrix>(SparseMatrix& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline Matrix GalerkinCylinderChebyshev::extend<Matrix>(const Matrix& gal)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline MatrixZ GalerkinCylinderChebyshev::extend<MatrixZ>(const MatrixZ& gal)
   {
      if(this->mIsComplex)
      {
   ...
   template <typename TData> inline TData GalerkinCylinderChebyshev::restrict(const TData& spec)
   {
...
#endif // GALERKINCYLINDERCHEBYSHEV_HPP
