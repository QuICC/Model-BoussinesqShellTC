/** 
 * @file TauShellChebyshev.hpp
 * @brief Implementation of the Tau conditions for chebyshev based operators for a shell radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef TAUSHELLCHEBYSHEV_HPP
#define TAUSHELLCHEBYSHEV_HPP
...
namespace Spectral {
    ...
    * @brief Implementation of the Tau conditions for chebyshev based operators for a shell radius
    */
   class TauShellChebyshev: public ITauBoundary
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         TauShellChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq);
   ...
   template <typename TData> inline const TData& TauShellChebyshev::extend(const TData& spec)
   {
      return spec;
   }

   template <typename TData> inline const TData& TauShellChebyshev::restrict(const TData& spec)
   {
      return spec;
   }

   template <typename TData> void TauShellChebyshev::constrainKronBlock(TData& mat)
   {
   }

   template <typename TData> bool TauShellChebyshev::constrainKronProduct(TData& mat)
   {
   ...
   template <> inline bool TauShellChebyshev::constrainKronProduct<SparseMatrixZ>(SparseMatrixZ& mat)
   {
      if(this->mIsComplex)
      {
         mat =  this->mZTau;
   ...
   template <> inline bool TauShellChebyshev::constrainKronProduct<DecoupledZSparse>(DecoupledZSparse& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline bool TauShellChebyshev::constrainKronProduct<SparseMatrix>(SparseMatrix& mat)
   {
      if(this->mIsComplex)
      {
