/** 
 * @file GalerkinShellChebyshev.hpp
 * @brief Implementation of the Galerkin basis for chebyshev based operators for a shell radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef GALERKINSHELLCHEBYSHEV_HPP
#define GALERKINSHELLCHEBYSHEV_HPP
...
namespace Spectral {
   ...
   class GalerkinShellChebyshev
   {
      public:
          ...
          */
         GalerkinShellChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq);

         /**
          * @brief Empty Destructor
          */
         ~GalerkinShellChebyshev();
   ...
   template <typename TData> void GalerkinShellChebyshev::constrainKronBlock(TData& mat)
   {
      Debug::StaticAssert<false>();
   }

   template <typename TData> bool GalerkinShellChebyshev::constrainKronProduct(TData& mat)
   {
      return false;
   }

   template <typename TData> TData GalerkinShellChebyshev::extend(const TData& gal)
   {
      Debug::StaticAssert<false>();
   }

   template <> inline void GalerkinShellChebyshev::constrainKronBlock<SparseMatrixZ>(SparseMatrixZ& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline void GalerkinShellChebyshev::constrainKronBlock<DecoupledZSparse>(DecoupledZSparse& mat)
   {
   ...
   template <> inline void GalerkinShellChebyshev::constrainKronBlock<SparseMatrix>(SparseMatrix& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline Matrix GalerkinShellChebyshev::extend<Matrix>(const Matrix& gal)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline MatrixZ GalerkinShellChebyshev::extend<MatrixZ>(const MatrixZ& gal)
   {
      if(this->mIsComplex)
      {
   ...
   template <typename TData> inline TData GalerkinShellChebyshev::restrict(const TData& spec)
   {
...
#endif // GALERKINSHELLCHEBYSHEV_HPP
