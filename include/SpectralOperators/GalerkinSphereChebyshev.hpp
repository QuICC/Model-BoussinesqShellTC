/** 
 * @file GalerkinSphereChebyshev.hpp
 * @brief Implementation of the Galerkin basis for chebyshev based operators for a sphere radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef GALERKINSPHERECHEBYSHEV_HPP
#define GALERKINSPHERECHEBYSHEV_HPP
...
namespace Spectral {
   ...
   class GalerkinSphereChebyshev
   {
      public:
          ...
          */
         GalerkinSphereChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq);

         /**
          * @brief Empty Destructor
          */
         ~GalerkinSphereChebyshev();
   ...
   template <typename TData> void GalerkinSphereChebyshev::constrainKronBlock(TData& mat)
   {
      Debug::StaticAssert<false>();
   }

   template <typename TData> bool GalerkinSphereChebyshev::constrainKronProduct(TData& mat)
   {
      return false;
   }

   template <typename TData> TData GalerkinSphereChebyshev::extend(const TData& gal)
   {
      Debug::StaticAssert<false>();
   }

   template <> inline void GalerkinSphereChebyshev::constrainKronBlock<SparseMatrixZ>(SparseMatrixZ& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline void GalerkinSphereChebyshev::constrainKronBlock<DecoupledZSparse>(DecoupledZSparse& mat)
   {
   ...
   template <> inline void GalerkinSphereChebyshev::constrainKronBlock<SparseMatrix>(SparseMatrix& mat)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline Matrix GalerkinSphereChebyshev::extend<Matrix>(const Matrix& gal)
   {
      if(this->mIsComplex)
      {
   ...
   template <> inline MatrixZ GalerkinSphereChebyshev::extend<MatrixZ>(const MatrixZ& gal)
   {
      if(this->mIsComplex)
      {
   ...
   template <typename TData> inline TData GalerkinSphereChebyshev::restrict(const TData& spec)
   {
...
#endif // GALERKINSPHERECHEBYSHEV_HPP
