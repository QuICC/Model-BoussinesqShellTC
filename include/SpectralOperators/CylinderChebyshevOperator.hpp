/** 
 * @file CylinderChebyshevOperator.hpp
 * @brief Implementation of the spectral operators for the chebyshev basis for a cylinder radius
 * @author Philippe Marti \<philippe.marti@colorado.edu\>
 */

#ifndef CYLINDERCHEBYSHEVOPERATOR_HPP
#define CYLINDERCHEBYSHEVOPERATOR_HPP
...
namespace Spectral {
   ...
   /**
    * @brief Implementation of the spectral operators for the chebyshev basis for an cylinder radius
    */
   class CylinderChebyshevOperator: public IOperator
   {
      public:
         /**
          * @brief Constructor
          ...
          */
         CylinderChebyshevOperator(const int basisN);

         /**
          * @brief Empty Destructor
          */
         ~CylinderChebyshevOperator();
...
#endif // CYLINDERCHEBYSHEVOPERATOR_HPP
