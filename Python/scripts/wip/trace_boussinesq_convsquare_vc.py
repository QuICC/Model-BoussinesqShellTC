"""Script to run a marginal curve trace for the Boussinesq rotating convection in a square (velocity-continuity formulation)"""

import numpy as np

import geomhdiscc.model.wip.boussinesq_convsquare_vc as mod

# Create the model and activate linearization
model = mod.BoussinesqConvSquareVC()
...
eigs = []
bc_vel = 0 # 0: NS/NS, 1: SF/SF, 2: SF/NS, 3: NS/SF
...
if show_solution:
    ...
    sol_t = evp_vec[2*res[0]*res[2]:3*res[0]*res[2],mode]
