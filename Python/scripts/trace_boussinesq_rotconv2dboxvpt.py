...
if True:
    ...
    sol_c = (mod.c2d.d1d0(res[0], res[2], 0, mod.no_bc())*evp_vec[0:res[0]*res[2],-1] + mod.c2d.d0d1(res[0], res[2], 0, mod.no_bc())*evp_vec[res[0]*res[2]:2*res[0]*res[2],-1]).reshape(res[0], res[2], order = 'F')
