...
import geomhdiscc.model.boussinesq_rrbcplane_compressible as mod
...
res = [512, 0, 0]
eq_params = {'prandtl':1, 'rayleigh':8.686001195839, 'ekman':1e-7, 'superadiabatic':1.0, 'gamma':1.0, 'polytropic':1.0, 'adiabatic':1.0, 'scale1d':2.0}
