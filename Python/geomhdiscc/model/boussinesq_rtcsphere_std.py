"""Module provides the functions to generate the Boussinesq rotating thermal convection in a sphere (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
...
class BoussinesqRTCSphereStd(base_model.BaseModel):
    """Class to setup the Boussinesq rotating thermal convection in a sphere (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
