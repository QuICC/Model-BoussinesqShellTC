"""Module provides the functions to generate the Boussinesq convection in a cylindrical annulus"""
...
class BoussinesqConvAnnulusVC(base_model.BaseModel):
    """Class to setup the Boussinesq convection in a cylindrical annulus"""
    ...
    def linear_block(self, res, eq_params, eigs, bcs, field_row, field_col):
        ...
        if field_row == ("velocityx",""):
            if field_col == ("velocityx",""):
                mat = annulus.i2j2x2lapl(res[0], res[2], m, a, b, bc, zscale = 2.0)
                bc['r'][0] = min(bc['r'][0], 0)
                bc['z'][0] = min(bc['z'][0], 0)
            ...
            if field_col == ("velocityx",""):
                ...
                mat = annulus.i2j2x2e1(res[0], res[2], a, b, bc, -1.0, zscale = 2.0)
            ...
            if field_col == ("velocityx",""):
                ...
                bc['z']['rt'] = 1
                bc['z']['cr'] = 1
                mat = annulus.i1j1x1e1(res[0]+1, res[2]+1, a, b, bc, zscale = 2.0).tolil()
                mat[-res[0]-2:-res[0],:] = 0
                mat[-2:,:] = 0
