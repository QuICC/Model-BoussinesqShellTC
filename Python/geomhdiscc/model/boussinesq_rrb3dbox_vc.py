...
class BoussinesqRRB3DBoxVC(base_model.BaseModel):
    ...
    def qi(self, res, eq_params, eigs, bcs, field_row, restriction = None):
        ...
        bc = self.convert_bc(eq_params,eigs,bcs,field_row,field_row)
        if field_row == ("velocityx",""):
            mat = c3d.i2j2k2(res[0], res[1], res[2], bc, restriction = restriction).tolil()
            mat[idx_u,:] = 0
    ...
    def linear_block(self, res, eq_params, eigs, bcs, field_row, field_col, restriction = None):
        ...
        zero_u, idx_u, zero_v, idx_v, zero_w, idx_w, zero_p, idx_p = self.zero_blocks(res, eigs, restriction = restriction)

        bc = self.convert_bc(eq_params,eigs,bcs,field_row,field_col)
        if field_row == ("velocityx",""):
            if field_col == ("velocityx",""):
                mat = c3d.i2j2k2lapl(res[0], res[1], res[2], bc, xscale = xscale, yscale = yscale, zscale = zscale, restriction = restriction).tolil()
                mat[idx_u,:] = 0
                mat[:,idx_u] = 0
                ...
                mat = c3d.i2j2k2(res[0], res[1], res[2], bc, T, restriction = restriction).tolil()
                mat[idx_u,:] = 0
                mat[:,idx_v] = 0
                ...
                mat = c3d.i2j2k2d1(res[0], res[1], res[2], bc, -1.0, xscale = xscale, restriction = restriction).tolil()
                mat[idx_u,:] = 0
                mat[:,idx_p] = 0
            ...
            if field_col == ("velocityx",""):
                ...
                mat = c3d.i2j2k2e1(res[0], res[1], res[2], bc, -1.0, yscale = yscale, restriction = restriction).tolil()
                mat[idx_v,:] = 0
                mat[:,idx_p] = 0
            ...
            if field_col == ("velocityx",""):
                ...
                mat = c3d.i2j2k2(res[0], res[1], res[2], bc, Ra/16.0, restriction = restriction).tolil()
                mat[idx_w,:] = 0

            elif field_col == ("pressure",""):
                mat = c3d.i2j2k2f1(res[0], res[1], res[2], bc, -1.0, zscale = zscale, restriction = restriction).tolil()
                mat[idx_w,:] = 0
                mat[:,idx_p] = 0
            ...
            if bcs["bcType"] == self.SOLVER_NO_TAU:
                ...
                if field_col == ("velocityx",""):
                    ...
                    bc['z']['rt'] = 1
                    bc['z']['zb'] = 1
                    mat = c3d.i1j1k1d1(res[0]+1, res[1]+1, res[2]+1, bc, xscale = xscale, restriction = restriction).tolil()
                    mat[:,idx_u] = 0
                    mat[idx_p,:] = 0
                    ...
                    bc['z']['rt'] = 1
                    bc['z']['zb'] = 1
                    mat = c3d.i1j1k1e1(res[0]+1, res[1]+1, res[2]+1, bc, yscale = yscale, restriction = restriction).tolil()
                    mat[:,idx_v] = 0
                    mat[idx_p,:] = 0
                    ...
                    bc['z']['rt'] = 1
                    bc['z']['zb'] = 1
                    mat = c3d.i1j1k1f1(res[0]+1, res[1]+1, res[2]+1, bc, zscale = zscale, restriction = restriction).tolil()
                    mat[:,idx_w] = 0
                    mat[idx_p,:] = 0
    ...
    def time_block(self, res, eq_params, eigs, bcs, field_row, restriction = None):
        ...
        bc = self.convert_bc(eq_params,eigs,bcs,field_row,field_row)
        if field_row == ("velocityx",""):
            mat = c3d.i2j2k2(res[0], res[1], res[2], bc, 1.0/Pr, restriction = restriction).tolil()
            mat[idx_u,:] = 0
            mat[:,idx_u] = 0
    ...
    def zero_blocks(self, res, eigs, restriction = None):
        ...
        zero_u = zero_u + utils.restricted_kron_3d(c1d.qid(res[1], res[1]-1, c1d.c1dbc.no_bc()), c1d.qid(res[2], 0, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_u = zero_u + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2], res[2]-1, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        ...
        zero_v = zero_v + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2], 0, c1d.c1dbc.no_bc()), c1d.qid(res[0], res[0]-1, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_v = zero_v + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2], res[2]-1, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        ...
        zero_w = zero_w + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2], 0, c1d.c1dbc.no_bc()), c1d.qid(res[0], res[0]-1, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_w = zero_w + utils.restricted_kron_3d(c1d.qid(res[1], res[1]-1, c1d.c1dbc.no_bc()), c1d.qid(res[2], 0, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        ...
        zero_p = zero_p + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2],0, c1d.c1dbc.no_bc()), c1d.qid(res[0], res[0]-1, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_p = zero_p + utils.restricted_kron_3d(c1d.qid(res[1], res[1]-1, c1d.c1dbc.no_bc()), c1d.qid(res[2],0, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_p = zero_p + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2],res[2]-1, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        # Pressure: T_{N-2:N,N-2:N,N-2:N}
        zero_p = zero_p + utils.restricted_kron_3d(c1d.qid(res[1], 0, c1d.c1dbc.no_bc()), c1d.qid(res[2],res[2]-3, c1d.c1dbc.no_bc()), c1d.qid(res[0], res[0]-3, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_p = zero_p + utils.restricted_kron_3d(c1d.qid(res[1], res[1]-3, c1d.c1dbc.no_bc()), c1d.qid(res[2],res[2]-3, c1d.c1dbc.no_bc()), c1d.qid(res[0], 0, c1d.c1dbc.no_bc()), restriction = restriction)
        zero_p = zero_p + utils.restricted_kron_3d(c1d.qid(res[1], res[1]-3, c1d.c1dbc.no_bc()), c1d.qid(res[2],0, c1d.c1dbc.no_bc()), c1d.qid(res[0], res[0]-3, c1d.c1dbc.no_bc()), restriction = restriction)
        # Pressure: T_000
        zero_p = zero_p + utils.restricted_kron_3d(c1d.sid(res[1], res[1]-1, c1d.c1dbc.no_bc()), c1d.sid(res[2],res[2]-1, c1d.c1dbc.no_bc()), c1d.sid(res[0], res[0]-1, c1d.c1dbc.no_bc()), restriction = restriction)
