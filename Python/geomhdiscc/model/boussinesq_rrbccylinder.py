        ...
        if field_row == ("velocity","tor"):                                    
            ...
            if field_col == ("velocity","tor"):
                ...
                if m == 0:
                    ...
                    mat += geo.tau_mat_r(res[0], res[2], m, {0:16, 'pad':1, 'kron_shift':0}, functools.partial(geo.c1d.i2d1, cscale = zscale), 2, 2, bc)
                ...
                bc['z'][0] = min(0, bc['z'][0])
                if m != 0:
                    mat += geo.tau_mat_r(res[0], res[2], m, {0:17, 'c':-1j*m, 'pad':1, 'kron_shift':0}, functools.partial(geo.c1d.i2), 2, 2, bc)
                    mat += geo.tau_mat_r(res[0], res[2], m, {0:15, 'c':-1j*m, 'pad':1, 'kron_shift':0}, functools.partial(geo.c1d.i2d2, cscale = zscale), 2, 2, bc)

            elif field_col == ("temperature",""):
                bc['r'][0] = min(0, bc['r'][0])
                bc['z'][0] = min(0, bc['z'][0])
                if m != 0:
                    mat += geo.tau_mat_r(res[0], res[2], m, {0:10, 'c':1j*m*Ra, 'pad':1, 'kron_shift':0}, functools.partial(geo.c1d.i2), 2, 2, bc)
            ...
            if field_col == ("velocity","tor"):
                ...
                bc['z'][0] = min(0, bc['z'][0])
                if m != 0:
                    mat += geo.tau_mat_r(res[0], res[2], m, {0:10, 'c':1j*m, 'pad':2, 'kron_shift':0}, functools.partial(geo.c1d.i4), 3, 4, bc)
                ...
                if m == 0:
                    ...
                    mat += geo.tau_mat_r(res[0], res[2], m, {0:11, 'pad':2, 'kron_shift':0}, functools.partial(geo.c1d.i4d1, cscale = zscale), 3, 4, bc)
