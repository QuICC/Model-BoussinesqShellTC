            ...
            if bcId == 0:
                if self.use_galerkin:
                    if field_row == ("streamfunction","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:-40, 'r':0}, 'z':{0:10, 'c':-1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("velocityz","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:-40, 'r':0}, 'z':{0:11, 'c':1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("streamfunction","") and field_col == ("velocityz",""):
                        bc = {'x':{0:-20, 'r':0}, 'z':{0:10}}
                    elif field_row == ("velocityz","") and field_col == ("velocityz",""):
                        bc = {'x':{0:-20, 'r':0}, 'z':{0:11}}
                    elif field_col == ("temperature",""):
                        bc = {'x':{0:-20, 'r':0}, 'z':{0:0}}

                else:
                    if field_row == ("streamfunction","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:40}, 'z':{0:10, 'c':-1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("velocityz","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:0}, 'z':{0:11, 'c':1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("streamfunction","") and field_col == ("velocityz",""):
                        bc = {'x':{0:0}, 'z':{0:10}}
                    elif field_row == ("velocityz","") and field_col == ("velocityz",""):
                        bc = {'x':{0:20}, 'z':{0:11}}
                ...
                if self.use_galerkin:
                    if field_row == ("streamfunction","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:-41, 'r':0}, 'z':{0:10, 'c':-1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("velocityz","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:-41, 'r':0}, 'z':{0:11, 'c':1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("streamfunction","") and field_col == ("velocityz",""):
                    ...
                    if field_row == ("streamfunction","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:41}, 'z':{0:10, 'c':-1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("velocityz","") and field_col == ("streamfunction",""):
                        bc = {'x':{0:0}, 'z':{0:11, 'c':1j*k*np.tan(chi*np.pi/180)/G}}
                    elif field_row == ("streamfunction","") and field_col == ("velocityz",""):
                        bc = {'x':{0:0}, 'z':{0:10}}
