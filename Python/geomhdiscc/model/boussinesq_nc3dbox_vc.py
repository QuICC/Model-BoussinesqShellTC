"""Module provides the functions to generate the Boussinesq natural convection in a 3D box (velocity-continuity formulation)"""
...
class BoussinesqNC3DBoxVC(base_model.BaseModel):
    """Class to setup the Boussinesq natural convetion in a 3D box (velocity-continuity formulation)"""
            ...
            # No-slip/Stress-free/Stress-free, Fixed temperature/Fixed flux/Fixed flux
                ...
                if self.use_galerkin:
                    ...
                    if field_row == ("velocityx","") and field_col == ("velocityx",""):
                        ...
                        bc = {'x':{0:20}, 'y':{0:21}, 'z':{0:21}, 'priority':'xsy'}
    ...
    def linear_block(self, res, eq_params, eigs, bcs, field_row, field_col, restriction = None):
        ...
        if field_row == ("velocityx",""):
            ...
            if field_col == ("velocityx",""):
                if self.linearize:
                    mat = c3d.i2j2k2(res[0], res[1], res[2], bc, restriction = restriction)
                    mat = mat*utils.qid_from_idx(idx_u, np.prod(res))
                else:
                    mat = c3d.zblk(res[0], res[1], res[2], 2, 2, 2, bc)
