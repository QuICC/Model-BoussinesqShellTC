...
from geomhdiscc.transform.spherical import thgrid, totphys, totleg, eqgrid as eqgrid_full
...
def torphys(spec, l, nr):
    ...
    n = spec.shape[0]
    for i in range(0, n):
        mat.append(wb.worland_poly(i, l, nrgrid(nr)))
    mat = np.matrix(mat)
...
def torspec(phys, l, n):
    ...
    for i in range(0, n):
        ...
        mat.append(w*wb.worland_poly(i, l, nr))
    mat = np.matrix(mat)
