...
def i2j2x3laplx_1(nr, nz, m, a, b, bc, coeff = 1.0, zscale = 1.0):
    """Create a i2x3laplx_1 in R kronecker with an i2 in Z"""

    bcr, bcz = convert_bc(bc)
    mat = spsp.kron(c1d.i2(nz,bcz), rad.i2x3laplhx_1(nr, m, a, b, bcr))
    bcr[0] = min(bcr[0], 0)
    bcz[0] = min(bcz[0], 0)
    mat = mat + spsp.kron(c1d.i2d2(nz,bcz, cscale = zscale), rad.i2x2(nr, a, b, bcr))
    mat = coeff*mat
