...
def apply_tau(mat, m, bc):
    ...
    if bc[0] == 10:
        cond = tau_value(mat.shape[0], m%2, bc[1:])
    elif bc[0] == 11:
        cond = tau_diff(mat.shape[0], m%2, bc[1:])
...
def apply_galerkin(mat, m, bc, eq_zero_rows):
