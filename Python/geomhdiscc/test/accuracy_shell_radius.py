...
if __name__ == "__main__":
    ...
    d1(nr, ls, a, b, rg)
    i2x2(nr, ls, a, b, rg)
    i2x2lapl(nr, ls, a, b, rg)
    i4x4(nr, ls, a, b, rg)
    i4x4lapl(nr, ls, a, b, rg)
    i4x4lapl2(nr, ls, a, b, rg)
    i2x1(nr, ls, a, b, rg)
    i2x2d1(nr, ls, a, b, rg)
    i4x3(nr, ls, a, b, rg)
    i4x4d1(nr, ls, a, b, rg)
