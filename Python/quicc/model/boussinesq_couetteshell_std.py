...
class BoussinesqCouetteShellStdVisu(BoussinesqCouetteShellBaseVisu):
    pass


class BoussinesqCouetteShellStdConfigOld:
...
class BoussinesqCouetteShellStdOld(BoussinesqCouetteShellStdConfig, base_model.BaseModel):
    """Class to setup the Boussinesq spherical Couette in a spherical shell (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
...
class BoussinesqCouetteShellStdVisuOld(BoussinesqCouetteShellStdConfig, base_model.BaseModel):
    """Class to setup the Boussinesq spherical Couette in a spherical shell (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
