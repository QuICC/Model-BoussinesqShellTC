"""Module provides the functions to generate the Boussinesq Rayleigh-Benard convection in a cylinder modified for parity (velocity-continuity formulation)"""
...
class BoussinesqRBCCylinderVC(base_model.BaseModel):
    """Class to setup the Boussinesq Rayleigh-Benard convection in a cylinder modified for parity (velocity-continuity formulation)"""
    ...
    def nonlinear_block(self, res, eq_params, eigs, bcs, field_row, field_col, restriction = None):
        ...
        if field_row == ("velocity","r") and field_col == field_row:
            mat = geo.i2j2x3(res[0], res[2], m%2, bc)
    ...
    def implicit_block(self, res, eq_params, eigs, bcs, field_row, field_col, restriction = None):
        ...
        if field_row == ("velocity","r"):
            if field_col == ("velocity","r"):
                mat = geo.i2j2x3vlaplx_1(res[0], res[2], m, m%2, bc, zscale = zscale)
                ...
                mat = geo.i2j2x3d1x_2(res[0], res[2], m%2, bc, -1.0)
            ...
            if field_col == ("velocity","r"):
                ...
                mat = geo.i2j2x2lapl(res[0], res[2], m, m%2, bc, zscale = zscale)
                ...
                mat = geo.i2j2x2(res[0], res[2], m%2, bc, Ra)
                mat = utils.qid_from_idx(idx_w, res[0]*res[2])*mat
            ...
            if bcs["bcType"] == self.SOLVER_HAS_BC:
                if field_col == ("velocity","r"):
                    ...
                    bc['z']['zb'] = 1
                    if m%2 == 1:
                        mat = geo.i1j1x1d1(res[0]+1, res[2]+1, m%2, bc)
                    else:
                        mat = geo.i1j1x1d1(res[0]+1, res[2]+1, m%2, bc)
                    ...
                    bc['z']['zb'] = 1
                    if m%2 == 1:
                        mat = geo.i1j1x2e1(res[0]+1, res[2]+1, m%2, bc, zscale = zscale)
                    else:
                        mat = geo.i1j1x2e1(res[0]+1, res[2]+1, m%2, bc, zscale = zscale)
                ...
                mat = geo.zblk(res[0], res[2], m%2, 1, 1, no_bc())
    ...
    def time_block(self, res, eq_params, eigs, bcs, field_row, restriction = None):
        ...
        if field_row == ("velocity","r"):
            mat = geo.i2j2x2(res[0], res[2], m%2, bc, 1.0/Pr)
