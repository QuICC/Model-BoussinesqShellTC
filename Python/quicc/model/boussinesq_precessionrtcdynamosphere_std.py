"""Module provides the functions to generate the Boussinesq combined precession and rotating thermal convection dynamo in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
...
class BoussinesqPrecessionRTCDynamoSphereStd(base_model.BaseModel):
    """Class to setup the Boussinesq rotating combined precession and thermal convection dynamo in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
    ...
    def nondimensional_parameters(self):
        ...
        return ["magnetic_prandtl", "poincare", "alpha", "ekman", "prandtl", "rayleigh"]
