...
class BoussinesqRRBCCylinderConfig:
    ...
    def implicit_block(self, res, eq_params, eigs, bcs, field_row, field_col, restriction = None):
        ...
        if field_row == ("velocity","tor"):
            if field_col == ("velocity","tor"):
                ...
                if m == 0:
                    mat = geo.i2j2e1(res[0], res[2], 1, bc, G**2/E, zscale = zscale, restriction = restriction)
                else:
                    mat = geo.i4laplhj2e1(res[0], res[2], m, bc, G**2/E, zscale = zscale, restriction = restriction)
            ...
            if field_col == ("velocity","tor"):
                if m == 0:
                    mat = geo.i4j4e1(res[0], res[2], 1, bc, -G**2/E, zscale = zscale, restriction = restriction)
                else:
                    mat = geo.i6laplhj4e1(res[0], res[2], m, bc, -G**2/E, zscale = zscale, restriction = restriction)
