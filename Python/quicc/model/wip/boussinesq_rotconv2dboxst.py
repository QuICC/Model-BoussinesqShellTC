"""Module provides the functions to generate the Boussinesq convection in a rotating 2D box model (streamfunction-temperature)"""
...
class BoussinesqRotConv2DBoxST(base_model.BaseModel):
    """Class to setup the Boussinesq convection in a rotating 2D box model (streamfunction-temperature)"""
    ...
    def linear_block(self, res, eq_params, eigs, bcs, field_row, field_col):
        ...
        if field_row == ("streamfunction",""):
            if field_col == ("streamfunction",""):
                ...
                mat = c2d.i4j4d1d0(res[0], res[2], bc, -Ra/16.0)
