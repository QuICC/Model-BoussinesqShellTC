"""Module provides the functions to generate the Boussinesq convection in a rotating box model (velocity-pressure)"""
...
class BoussinesqRotConvBoxVP(base_model.BaseModel):
    """Class to setup the Boussinesq convection in a rotating box model (velocity-pressure)"""
            ...
            # Stress-free + velocity conditions
                ...
                if self.use_galerkin:
                    ...
                    if field_row == ("velocityx","") and field_col == ("velocityx",""):
                        ...
                        bc = {'x':{0:22}, 'z':{0:0}, 'priority':'n'}
                    elif field_row == ("pressure","") and field_col == ("velocityz",""):
                        bc = {'x':{0:0}, 'z':{0:22}, 'priority':'n'}
    ...
    def linear_block(self, res, eq_params, eigs, bcs, field_row, field_col):
        ...
        if field_row == ("velocityx",""):
            ...
            if field_col == ("velocityx",""):
                ...
                mat = c2d.i2j2d1d0(res[0], res[2], bc, Ta**0.5)
                ...
                mat = c2d.i2j2d0d1(res[0], res[2], bc, Ra)
