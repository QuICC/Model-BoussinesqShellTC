"""Module provides the functions to generate the Boussinesq convection in a rotating disk model"""
...
class BoussinesqRotConvDisk(base_model.BaseModel):
    """Class to setup the Boussinesq convection in a rotating disk model"""
    ...
    def stability_fields(self):
        ...
        fields =  [("velocityx",""), ("velocityy",""), ("pressure",""), ("temperature","")]
    ...
    def linear_block(self, res, eq_params, eigs, bcs, field_row, field_col):
        ...
        if field_row == ("velocityx",""):
            if field_col == ("velocityx",""):
                ...
                bc[0] = min(bc[0], 0)
                mat = mat + annulus.i2x2(res[0], a, b, bc, Ta**0.5)

            elif field_col == ("pressure",""):
                mat = annulus.i2x2d1(res[0], 2, 2, bc, -1.0)
            ...
            if field_col == ("velocityx",""):
                mat = annulus.i2x1(res[0], a, b, bc, -1j*m*Ta**0.5)

            elif field_col == ("velocityy",""):
                mat = annulus.i2x2div(res[0], a, b, bc, Ta**0.5)

            elif field_col == ("pressure",""):
                mat = annulus.i2x2laplh(res[0], m, a, b, bc, -1.0)
