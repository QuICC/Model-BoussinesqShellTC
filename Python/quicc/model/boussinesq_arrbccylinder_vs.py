"""Module provides the functions to generate the axisymmetric Boussinesq rotating Rayleigh-Benard convection in a cylinder (vorticity-streamfunction formulation)"""
...
class BoussinesqARRBCCylinderVS(base_model.BaseModel):
    """Class to setup the axisymmetric Boussinesq rotating Rayleigh-Benard convection in a cylinder (vorticity-streamfunction formulation)"""
    ...
    def config_fields(self):
        ...
        return ["vorticity", "streamfunction", "velocity", "temperature"]

    def stability_fields(self):
        """Get the list of fields needed for linear stability calculations"""

        fields =  [("vorticity",""), ("streamfunction",""), ("velocity",""), ("temperature","")]
