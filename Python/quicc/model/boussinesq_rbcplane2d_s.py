"""Module provides the functions to generate the Boussinesq Rayleigh-Benard convection in a plane layer (2D) (streamfunction formulation)"""
...
class BoussinesqRBCPlane2DS(base_model.BaseModel):
    """Class to setup the Boussinesq Rayleigh-Benard convection in a plane layer (2D) (streamfunction formulation)"""
    ...
    def implicit_block(self, res, eq_params, eigs, bcs, field_row, field_col, restriction = None):
        ...
        if field_row == ("streamfunction",""):
            if field_col == ("streamfunction",""):
                mat = geo.i4lapl2(res[0], k, 0, bc, cscale = zscale)

            elif field_col == ("temperature",""):
                mat = geo.i4(res[0], bc, 1j*k*Ra)
    ...
    def time_block(self, res, eq_params, eigs, bcs, field_row, restriction = None):
        ...
        if field_row == ("streamfunction",""):
            mat = geo.i4lapl(res[0], k, 0, bc, 1.0/Pr, cscale = zscale)
