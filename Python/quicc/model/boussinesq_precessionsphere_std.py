"""Module provides the functions to generate the Boussinesq precession simulation in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
...
class BoussinesqPrecessionSphereStd(base_model.BaseModel):
    """Class to setup the Boussinesq precession simulation in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
