"""Module provides the functions to generate the Boussinesq precession dynamo in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
...
class BoussinesqPrecessionDynamoSphereStd(base_model.BaseModel):
    """Class to setup the Boussinesq precession dynamo in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
    ...
    def nondimensional_parameters(self):
        ...
        return ["magnetic_prandtl", "poincare", "alpha", "ekman"]
