"""Module provides the functions to generate the Boussinesq combined precession and rotating thermal convection in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
...
class BoussinesqPrecessionRTCSphereStd(base_model.BaseModel):
    """Class to setup the Boussinesq combined precession and rotating thermal convection in a sphere with Worland expansion (Toroidal/Poloidal formulation) without field coupling (standard implementation)"""
    ...
    def nondimensional_parameters(self):
        ...
        return ["poincare", "alpha", "ekman", "prandtl", "rayleigh"]
