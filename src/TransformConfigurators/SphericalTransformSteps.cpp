...
namespace TransformSteps {
   ...
   std::vector<TransformBranch>  backwardGradient()
   {
      ...
      transform.push_back(FieldComponents::Spectral::SCALAR, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::THREE, FieldType::GRADIENT);
   ...
   std::vector<TransformBranch>  backwardVGradient()
   {
      ...
      transform.push_back(FieldComponents::Spectral::ONE, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::THREE, FieldType::GRADIENT);
      ...
      transform.push_back(FieldComponents::Spectral::TWO, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::THREE, FieldType::GRADIENT);
      ...
      transform.push_back(FieldComponents::Spectral::THREE, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::THREE, FieldType::GRADIENT);
   ...
   std::vector<TransformBranch>  backwardCurl()
   {
      ...
      transform.push_back(FieldComponents::Spectral::ONE, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::TWO, FieldType::CURL);
      ...
      transform.push_back(FieldComponents::Spectral::TWO, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::ONE, FieldType::CURL);
      ...
      transform.push_back(FieldComponents::Spectral::THREE, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSINDIFFSIN, TransformBranch::Proj3DType::PROJ, FieldComponents::Physical::ONE, FieldType::CURL);
      transform.push_back(FieldComponents::Spectral::THREE, TransformBranch::Proj1DType::DIVRDIFFR, TransformBranch::Proj2DType::PROJ, TransformBranch::Proj3DType::PROJ, FieldComponents::Physical::TWO, FieldType::CURL);
   ...
   std::vector<TransformBranch>  backwardDivergence()
   {
      ...
      transform.push_back(FieldComponents::Spectral::ONE, TransformBranch::Proj1DType::DIFF, TransformBranch::Proj2DType::PROJ, TransformBranch::Proj3DType::PROJ, FieldComponents::Physical::SCALAR, FieldType::DIVERGENCE);

      transform.push_back(FieldComponents::Spectral::TWO, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSINDIFFSIN, TransformBranch::Proj3DType::PROJ, FieldComponents::Physical::SCALAR, FieldType::DIVERGENCE);

      transform.push_back(FieldComponents::Spectral::THREE, TransformBranch::Proj1DType::DIVR, TransformBranch::Proj2DType::DIVSIN, TransformBranch::Proj3DType::DIFF, FieldComponents::Physical::SCALAR, FieldType::DIVERGENCE);
