...
namespace Transform {
   ...
   void ForwardSingle2DConfigurator::firstStep(SharedScalarEquation spEquation, TransformCoordinatorType& coord)
   {
   ...
   void ForwardSingle2DConfigurator::firstStep(SharedVectorEquation spEquation, TransformCoordinatorType& coord)
   {
      // Compute the nonlinear interaction
   ...
   void ForwardSingle2DConfigurator::lastStep(SharedScalarEquation spEquation, TransformCoordinatorType& coord)
   {
      // Start profiler
      ProfilerMacro_start(ProfilerMacro::FWDTRANSFORM);
   ...
   void ForwardSingle2DConfigurator::lastStep(SharedVectorEquation spEquation, TransformCoordinatorType& coord)
   {
      // Start profiler
      ProfilerMacro_start(ProfilerMacro::FWDTRANSFORM);
   ...
   void ForwardSingle2DConfigurator::secondStep(SharedScalarEquation spEquation, TransformCoordinatorType& coord)
   {
      // No need for second step
   }

   void ForwardSingle2DConfigurator::secondStep(SharedVectorEquation spEquation, TransformCoordinatorType& coord)
   {
      // No need for second step
   }
