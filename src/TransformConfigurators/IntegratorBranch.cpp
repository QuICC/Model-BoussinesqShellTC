...
namespace Transform {
   ...
   IntegratorBranch::IntegratorBranch(FieldComponents::Physical::Id physId, IntegratorBranch::Intg3DId intg3D, IntegratorBranch::Intg2DId intg2D, IntegratorBranch::Intg1DId intg1D, FieldComponents::Spectral::Id specId, FieldType::Id fieldId)
      :mPhysId(physId), mIntg1D(intg1D), mIntg2D(intg2D), mIntg3D(intg3D), mSpecId(specId), mFieldId(fieldId)
   {
   }
