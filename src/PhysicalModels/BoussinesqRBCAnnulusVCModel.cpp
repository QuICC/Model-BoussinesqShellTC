/** 
 * @file BoussinesqRBCAnnulusVCModel.cpp
...
// Class include
//
#include "PhysicalModels/BoussinesqRBCAnnulusVCModel.hpp"
...
#include "Equations/Annulus/Boussinesq/BoussinesqRBCAnnulusVCTransport.hpp"
#include "Equations/Annulus/Boussinesq/BoussinesqRBCAnnulusVCMomentum.hpp"
#include "Equations/Annulus/Boussinesq/BoussinesqRBCAnnulusVCContinuity.hpp"
...
namespace GeoMHDiSCC {
   ...
   const std::string BoussinesqRBCAnnulusVCModel::PYMODULE = "boussinesq_rbcannulus_vc";

   const std::string BoussinesqRBCAnnulusVCModel::PYCLASS = "BoussinesqRBCAnnulusVC";

   void BoussinesqRBCAnnulusVCModel::addEquations(SharedSimulation spSim)
   {
      // Add transport equation
      spSim->addScalarEquation<Equations::BoussinesqRBCAnnulusVCTransport>();
      
      // Add Navier-Stokes equation (X,Y,Z components)
      spSim->addVectorEquation<Equations::BoussinesqRBCAnnulusVCMomentum>();

      // Add continuity equation
      spSim->addScalarEquation<Equations::BoussinesqRBCAnnulusVCContinuity>();
   }

   void BoussinesqRBCAnnulusVCModel::addStates(SharedStateGenerator spGen)
   {
   ...
   void BoussinesqRBCAnnulusVCModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqRBCAnnulusVCModel::setVisualizationState(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqRBCAnnulusVCModel::addAsciiOutputFiles(SharedSimulation spSim)
   {
...
//      spSim->addAsciiOutputFile(spState);
   ...
   void BoussinesqRBCAnnulusVCModel::addHdf5OutputFiles(SharedSimulation spSim)
   {
      // Field IDs iterator
   ...
   void BoussinesqRBCAnnulusVCModel::addStatsOutputFiles(SharedSimulation spSim)
   {
   }

   void BoussinesqRBCAnnulusVCModel::setInitialState(SharedSimulation spSim)
   {
      // Field IDs iterator
      std::vector<PhysicalNames::Id>::const_iterator  it;
      std::vector<PhysicalNames::Id> ids = PhysicalModelBase::fieldIds();
