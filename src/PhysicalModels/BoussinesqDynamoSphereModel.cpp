/** 
 * @file BoussinesqDynamoSphereModel.cpp
...
// Class include
//
#include "PhysicalModels/BoussinesqDynamoSphereModel.hpp"
...
namespace GeoMHDiSCC {
   ...
   const std::string BoussinesqDynamoSphereModel::PYMODULE = "boussinesq_dynamosphere";

   const std::string BoussinesqDynamoSphereModel::PYCLASS = "BoussinesqDynamoSphere";

   void BoussinesqDynamoSphereModel::addEquations(SharedSimulation spSim)
   {
   ...
   void BoussinesqDynamoSphereModel::addStates(SharedStateGenerator spGen)
   {
   ...
   void BoussinesqDynamoSphereModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqDynamoSphereModel::setVisualizationState(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqDynamoSphereModel::addAsciiOutputFiles(SharedSimulation spSim)
   {
   ...
   void BoussinesqDynamoSphereModel::addHdf5OutputFiles(SharedSimulation spSim)
   {
      // Field IDs iterator
   ...
   void BoussinesqDynamoSphereModel::addStatsOutputFiles(SharedSimulation spSim)
   {
   }

   void BoussinesqDynamoSphereModel::setInitialState(SharedSimulation spSim)
   {
      // Field IDs iterator
      std::vector<PhysicalNames::Id>::const_iterator  it;
      std::vector<PhysicalNames::Id> ids = PhysicalModelBase::fieldIds();
