/** 
 * @file BoussinesqDynamoPlaneModel.cpp
...
// Class include
//
#include "PhysicalModels/BoussinesqDynamoPlaneModel.hpp"

// Project includes
//
#include "Enums/FieldIds.hpp"
#include "Equations/Box/Boussinesq/BoussinesqDynamoPlaneTransport.hpp"
...
namespace QuICC {
   ...
   const std::string BoussinesqDynamoPlaneModel::PYMODULE = "boussinesq_dynamoplane";

   const std::string BoussinesqDynamoPlaneModel::PYCLASS = "BoussinesqDynamoPlane";

   void BoussinesqDynamoPlaneModel::addEquations(SharedSimulation spSim)
   {
      // Add transport equation
      spSim->addScalarEquation<Equations::BoussinesqDynamoPlaneTransport>();
      
      // Add Navier-Stokes equation
      spSim->addVectorEquation<Equations::BoussinesqDynamoPlaneMomentum>();
      
      // Add Induction equation
      spSim->addVectorEquation<Equations::BoussinesqDynamoPlaneInduction>();
   }

   void BoussinesqDynamoPlaneModel::addStates(SharedStateGenerator spGen)
   {
   ...
   void BoussinesqDynamoPlaneModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqDynamoPlaneModel::setVisualizationState(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqDynamoPlaneModel::addAsciiOutputFiles(SharedSimulation spSim)
   {
   ...
   void BoussinesqDynamoPlaneModel::addHdf5OutputFiles(SharedSimulation spSim)
   {
      // Field IDs iterator
   ...
   void BoussinesqDynamoPlaneModel::addStatsOutputFiles(SharedSimulation spSim)
   {
   }

   void BoussinesqDynamoPlaneModel::setInitialState(SharedSimulation spSim)
   {
      // Field IDs iterator
      std::vector<PhysicalNames::Id>::const_iterator  it;
      std::vector<PhysicalNames::Id> ids = PhysicalModelBase::fieldIds();
