/** 
 * @file BoussinesqCouetteShellHyperviscousModel.cpp
...
// Class include
//
#include "PhysicalModels/BoussinesqCouetteShellHyperviscousModel.hpp"
...
namespace QuICC {
   ...
   const std::string BoussinesqCouetteShellHyperviscousModel::PYMODULE = "boussinesq_couetteshell_hyperviscous";

   const std::string BoussinesqCouetteShellHyperviscousModel::PYCLASS = "BoussinesqCouetteShellHyperviscous";

   void BoussinesqCouetteShellHyperviscousModel::addEquations(SharedSimulation spSim)
   {
      // Add Navier-Stokes equation
      spSim->addVectorEquation<Equations::BoussinesqCouetteShellMomentum>();
   }

   void BoussinesqCouetteShellHyperviscousModel::addStates(SharedStateGenerator spGen)
   {
   ...
   void BoussinesqCouetteShellHyperviscousModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqCouetteShellHyperviscousModel::setVisualizationState(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqCouetteShellHyperviscousModel::addAsciiOutputFiles(SharedSimulation spSim)
   {
   ...
   void BoussinesqCouetteShellHyperviscousModel::addHdf5OutputFiles(SharedSimulation spSim)
   {
      // Field IDs iterator
   ...
   void BoussinesqCouetteShellHyperviscousModel::addStatsOutputFiles(SharedSimulation spSim)
   {
   }

   void BoussinesqCouetteShellHyperviscousModel::setInitialState(SharedSimulation spSim)
   {
      // Field IDs iterator
      std::vector<PhysicalNames::Id>::const_iterator  it;
      std::vector<PhysicalNames::Id> ids = PhysicalModelBase::fieldIds();
