/** 
 * @file BoussinesqTCSphereStdModel.cpp
...
// Class include
//
#include "PhysicalModels/BoussinesqTCSphereStdModel.hpp"
...
namespace GeoMHDiSCC {
   ...
   const std::string BoussinesqTCSphereStdModel::PYMODULE = "boussinesq_tcsphere_std";

   const std::string BoussinesqTCSphereStdModel::PYCLASS = "BoussinesqTCSphereStd";

   void BoussinesqTCSphereStdModel::addEquations(SharedSimulation spSim)
   {
   ...
   void BoussinesqTCSphereStdModel::addStates(SharedStateGenerator spGen)
   {
   ...
   void BoussinesqTCSphereStdModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqTCSphereStdModel::setVisualizationState(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqTCSphereStdModel::addAsciiOutputFiles(SharedSimulation spSim)
   {
   ...
   void BoussinesqTCSphereStdModel::addHdf5OutputFiles(SharedSimulation spSim)
   {
      // Field IDs iterator
   ...
   void BoussinesqTCSphereStdModel::addStatsOutputFiles(SharedSimulation spSim)
   {
   }

   void BoussinesqTCSphereStdModel::setInitialState(SharedSimulation spSim)
   {
      // Field IDs iterator
      std::vector<PhysicalNames::Id>::const_iterator  it;
      std::vector<PhysicalNames::Id> ids = PhysicalModelBase::fieldIds();
