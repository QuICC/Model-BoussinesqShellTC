...
namespace GeoMHDiSCC {
   ...
   void BoussinesqRB2DBoxVCModel::addStates(SharedStateGenerator spGen)
   {
      ...
      if(false)
      {
         ...
         spVector->setStateType(FieldComponents::Physical::X, Equations::CartesianExactVectorState::POLYSINPOLY);
         spVector->setModeOptions(FieldComponents::Physical::X, 1.0e0, 1.0, 1.0e0, 1.0, 1.0e0, 1.0);
         spVector->setStateType(FieldComponents::Physical::Y, Equations::CartesianExactVectorState::POLYSINPOLY);
         spVector->setModeOptions(FieldComponents::Physical::Y, 1.0e0, 1.0, 1.0e0, 1.0, 1.0e0, 1.0);
         spVector->setStateType(FieldComponents::Physical::Z, Equations::CartesianExactVectorState::POLYSINPOLY);
