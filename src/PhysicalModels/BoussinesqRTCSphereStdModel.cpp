/** 
 * @file BoussinesqRTCSphereStdModel.cpp
...
// Class include
//
#include "PhysicalModels/BoussinesqRTCSphereStdModel.hpp"
...
namespace GeoMHDiSCC {
   ...
   const std::string BoussinesqRTCSphereStdModel::PYMODULE = "boussinesq_rtcsphere_std";

   const std::string BoussinesqRTCSphereStdModel::PYCLASS = "BoussinesqRTCSphereStd";

   void BoussinesqRTCSphereStdModel::addEquations(SharedSimulation spSim)
   {
   ...
   void BoussinesqRTCSphereStdModel::addStates(SharedStateGenerator spGen)
   {
   ...
   void BoussinesqRTCSphereStdModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqRTCSphereStdModel::setVisualizationState(SharedVisualizationGenerator spVis)
   {
   ...
   void BoussinesqRTCSphereStdModel::addAsciiOutputFiles(SharedSimulation spSim)
   {
   ...
   void BoussinesqRTCSphereStdModel::addHdf5OutputFiles(SharedSimulation spSim)
   {
      // Field IDs iterator
   ...
   void BoussinesqRTCSphereStdModel::addStatsOutputFiles(SharedSimulation spSim)
   {
   }

   void BoussinesqRTCSphereStdModel::setInitialState(SharedSimulation spSim)
   {
      // Field IDs iterator
      std::vector<PhysicalNames::Id>::const_iterator  it;
      std::vector<PhysicalNames::Id> ids = PhysicalModelBase::fieldIds();
