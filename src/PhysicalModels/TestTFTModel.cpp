...
namespace GeoMHDiSCC {
   ...
   void TestTFTModel::addEquations(SharedSimulation spSim)
   {
      ...
      spLin = spSim->addScalarEquation<Equations::TestLinearScalar>(TestTFTModel::PYNAME);
   ...
   void TestTFTModel::addStates(SharedStateGenerator spGen)
   {
      ...
      spExact = spGen->addScalarEquation<Equations::CartesianExactScalarState>(TestTFTModel::PYNAME);
   ...
   void TestTFTModel::addVisualizers(SharedVisualizationGenerator spVis)
   {
      ...
      spField = spVis->addScalarEquation<Equations::ScalarFieldVisualizer>(TestTFTModel::PYNAME);
