...
namespace Schemes {
   ...
   std::string BLFmScheme::type()
   {
      return "BLFm";
   }

   void BLFmScheme::tuneResolution(SharedResolution spRes, const Parallel::SplittingDescription& descr)
   {
   ...
   Transform::SharedFftSetup BLFmScheme::spSetup1D(SharedResolution spRes) const
   {
   ...
   Transform::SharedFftSetup BLFmScheme::spSetup3D(SharedResolution spRes) const
   {
      // Get size of FFT transform
   ...
   BLFmScheme::BLFmScheme(const ArrayI& dim)
      : IRegularSHmScheme(dim)
   {
   }

   BLFmScheme::~BLFmScheme()
   {
   }

   void BLFmScheme::setDimensions()
   {
      //
   ...
   void BLFmScheme::setMemoryScore()
   {
   ...
   bool BLFmScheme::applicable() const
   {
      return true;
   }
}
