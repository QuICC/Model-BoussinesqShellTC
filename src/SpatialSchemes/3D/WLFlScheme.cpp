...
namespace Schemes {
   ...
   std::string WLFlScheme::type()
   {
      return "WLFl";
   }

   void WLFlScheme::addTransformSetups(SharedResolution spRes) const
   {
   ...
   Transform::SharedPolySetup WLFlScheme::spSetup1D(SharedResolution spRes) const
   {
   ...
   WLFlScheme::WLFlScheme(const ArrayI& dim)
      : IRegularSHlScheme(dim)
   {
   }

   WLFlScheme::~WLFlScheme()
   {
   }

   void WLFlScheme::setDimensions()
   {
      //
   ...
   void WLFlScheme::setMemoryScore()
   {
   ...
   bool WLFlScheme::applicable() const
   {
      return true;
   }
}
