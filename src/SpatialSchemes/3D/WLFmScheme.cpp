...
namespace Schemes {
   ...
   std::string WLFmScheme::type()
   {
      return "WLFm";
   }

   void WLFmScheme::tuneResolution(SharedResolution spRes, const Parallel::SplittingDescription& descr)
   {
   ...
   Transform::SharedPolySetup WLFmScheme::spSetup1D(SharedResolution spRes) const
   {
   ...
   Transform::SharedPolySetup WLFmScheme::spSetup2D(SharedResolution spRes) const
   {
      // Get physical size of polynomial transform
   ...
   Transform::SharedFftSetup WLFmScheme::spSetup3D(SharedResolution spRes) const
   {
   ...
   WLFmScheme::WLFmScheme(const ArrayI& dim)
      : IRegularSHmScheme(dim)
   {
   }

   WLFmScheme::~WLFmScheme()
   {
   }

   void WLFmScheme::setDimensions()
   {
      //
   ...
   void WLFmScheme::setMemoryScore()
   {
   ...
   bool WLFmScheme::applicable() const
   {
      return true;
   }
}
