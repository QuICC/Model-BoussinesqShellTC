...
namespace Schemes {
   ...
   Transform::SharedFftSetup TTTScheme::spSetup1D(SharedResolution spRes) const
   {
   ...
   Transform::SharedFftSetup TTTScheme::spSetup2D(SharedResolution spRes) const
   {
      // Get size of FFT transform
   ...
   Transform::SharedFftSetup TTTScheme::spSetup3D(SharedResolution spRes) const
   {
      // Get size of FFT transform
   ...
   TTTScheme::TTTScheme(const ArrayI& dim)
   ...
   bool TTTScheme::applicable() const
   {
      return true;
   }
}
