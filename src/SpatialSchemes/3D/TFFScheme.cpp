...
namespace GeoMHDiSCC {
   ...
   Transform::SharedFftSetup TFFScheme::spSetup1D(SharedResolution spRes)
   {
   ...
   Transform::SharedFftSetup TFFScheme::spSetup2D(SharedResolution spRes)
   {
      // Get size of FFT transform
      int size = spRes->cpu()->dim(Dimensions::Transform::TRA1D)->dim<Dimensions::Data::DATF1D>();
   ...
   Transform::SharedFftSetup TFFScheme::spSetup3D(SharedResolution spRes)
   {
      // Get size of FFT transform
      int size = spRes->cpu()->dim(Dimensions::Transform::TRA1D)->dim<Dimensions::Data::DATF1D>();
