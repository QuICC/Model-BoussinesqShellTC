/** 
 * @file BoussinesqRBCBoxVCMomentum.cpp
...
namespace Equations {
   ...
   BoussinesqRBCBoxVCMomentum::BoussinesqRBCBoxVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRBCBoxVCMomentum::~BoussinesqRBCBoxVCMomentum()
   {
   }

   void BoussinesqRBCBoxVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRBCBoxVCMomentum::setNLComponents()
   {
   ...
   void BoussinesqRBCBoxVCMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
      // Get Prandtl number
   ...
   void BoussinesqRBCBoxVCMomentum::setRequirements()
   {
