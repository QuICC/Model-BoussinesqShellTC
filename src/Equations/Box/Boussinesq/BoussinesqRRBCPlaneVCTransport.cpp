/** 
 * @file BoussinesqRRBCPlaneVCTransport.cpp
 * @brief Source of the implementation of the transport equation for rotating Rayleigh-Benard convection in a plane layer
...
namespace Equations {
   ...
   BoussinesqRRBCPlaneVCTransport::BoussinesqRRBCPlaneVCTransport(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBCPlaneVCTransport::~BoussinesqRRBCPlaneVCTransport()
   {
   }

   void BoussinesqRRBCPlaneVCTransport::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 1, true, false);
   }

   void BoussinesqRRBCPlaneVCTransport::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRRBCPlaneVCTransport::setRequirements()
   {
