/** 
 * @file BoussinesqRRBCPlaneVCMomentum.cpp
 * @brief Source of the implementation of the vector momentum equation for rotating Rayleigh-Benard convection in a plane layer
...
namespace Equations {
   ...
   BoussinesqRRBCPlaneVCMomentum::BoussinesqRRBCPlaneVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBCPlaneVCMomentum::~BoussinesqRRBCPlaneVCMomentum()
   {
   }

   void BoussinesqRRBCPlaneVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRRBCPlaneVCMomentum::setNLComponents()
   {
   ...
   void BoussinesqRRBCPlaneVCMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
      // Get Prandtl number
   ...
   void BoussinesqRRBCPlaneVCMomentum::setRequirements()
   {
