/** 
 * @file BoussinesqNC3DBoxVCVelocityX.cpp
 * @brief Source of the implementation of th momentum equation for the X component in natural convection in 3D box
...
namespace Equations {
   ...
   BoussinesqNC3DBoxVCVelocityX::BoussinesqNC3DBoxVCVelocityX(SharedEquationParameters spEqParams)
   ...
   BoussinesqNC3DBoxVCVelocityX::~BoussinesqNC3DBoxVCVelocityX()
   {
   }

   void BoussinesqNC3DBoxVCVelocityX::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqNC3DBoxVCVelocityX::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqNC3DBoxVCVelocityX::setRequirements()
   {
