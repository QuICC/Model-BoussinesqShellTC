/** 
 * @file BoussinesqNC3DBoxVCVelocityY.cpp
 * @brief Source of the implementation of th momentum equation for the Y component in natural convection in 3D box
...
namespace Equations {
   ...
   BoussinesqNC3DBoxVCVelocityY::BoussinesqNC3DBoxVCVelocityY(SharedEquationParameters spEqParams)
   ...
   BoussinesqNC3DBoxVCVelocityY::~BoussinesqNC3DBoxVCVelocityY()
   {
   }

   void BoussinesqNC3DBoxVCVelocityY::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqNC3DBoxVCVelocityY::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqNC3DBoxVCVelocityY::setRequirements()
   {
