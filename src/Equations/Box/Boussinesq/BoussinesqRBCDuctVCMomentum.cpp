/** 
 * @file BoussinesqRBCDuctVCMomentum.cpp
 * @brief Source of the implementation of the vector momentum equation in Rayleigh-Benard convection in a infinite duct
...
namespace Equations {
   ...
   BoussinesqRBCDuctVCMomentum::BoussinesqRBCDuctVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRBCDuctVCMomentum::~BoussinesqRBCDuctVCMomentum()
   {
   }

   void BoussinesqRBCDuctVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRBCDuctVCMomentum::setNLComponents()
   {
   ...
   void BoussinesqRBCDuctVCMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
      // Get Prandtl number
   ...
   void BoussinesqRBCDuctVCMomentum::setRequirements()
   {
