/** 
 * @file BoussinesqRB3DBoxVCVelocityZ.cpp
 * @brief Source of the implementation of th momentum equation for the Z component in Rayleigh-Benard convection in 3D box
...
namespace Equations {
   ...
   BoussinesqRB3DBoxVCVelocityZ::BoussinesqRB3DBoxVCVelocityZ(SharedEquationParameters spEqParams)
   ...
   BoussinesqRB3DBoxVCVelocityZ::~BoussinesqRB3DBoxVCVelocityZ()
   {
   }

   void BoussinesqRB3DBoxVCVelocityZ::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqRB3DBoxVCVelocityZ::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRB3DBoxVCVelocityZ::setRequirements()
   {
