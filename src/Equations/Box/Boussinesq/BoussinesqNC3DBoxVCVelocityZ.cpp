/** 
 * @file BoussinesqNC3DBoxVCVelocityZ.cpp
 * @brief Source of the implementation of th momentum equation for the Z component in natural convection in 3D box
...
namespace Equations {
   ...
   BoussinesqNC3DBoxVCVelocityZ::BoussinesqNC3DBoxVCVelocityZ(SharedEquationParameters spEqParams)
   ...
   BoussinesqNC3DBoxVCVelocityZ::~BoussinesqNC3DBoxVCVelocityZ()
   {
   }

   void BoussinesqNC3DBoxVCVelocityZ::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqNC3DBoxVCVelocityZ::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqNC3DBoxVCVelocityZ::setRequirements()
   {
