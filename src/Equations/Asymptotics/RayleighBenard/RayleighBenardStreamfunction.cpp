...
namespace Equations {
   ...
   void RayleighBenardStreamfunction::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp) const
   {
      /// 
   ...
   void RayleighBenardStreamfunction::computeLinear(Datatypes::SpectralScalarType& rRHS) const
   {  
      ///
