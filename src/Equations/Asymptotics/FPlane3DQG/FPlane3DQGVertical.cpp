...
namespace Equations {
   ...
   FPlane3DQGVertical::FPlane3DQGVertical(SharedIEquationParameters spEqParams)
   ...
   void FPlane3DQGVertical::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp) const
   {
      /// 
