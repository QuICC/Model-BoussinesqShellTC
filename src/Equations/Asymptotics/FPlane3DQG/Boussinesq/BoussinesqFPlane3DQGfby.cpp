/** 
 * @file BoussinesqFPlane3DQGfby.cpp
...
// Class include
//
#include "Equations/Asymptotics/FPlane3DQG/Boussinesq/BoussinesqFPlane3DQGfby.hpp"
...
namespace Equations {
   ...
   BoussinesqFPlane3DQGfby::BoussinesqFPlane3DQGfby(SharedEquationParameters spEqParams)
   ...
   BoussinesqFPlane3DQGfby::~BoussinesqFPlane3DQGfby()
   {
   }

   void BoussinesqFPlane3DQGfby::setCoupling()
   {	
   ...
   void BoussinesqFPlane3DQGfby::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   Datatypes::SpectralScalarType::PointType BoussinesqFPlane3DQGfby::sourceTerm(FieldComponents::Spectral::Id compId, const int iX, const int iZ, const int iY) const
   {
      // Assert on scalar component is used
   ...
   void BoussinesqFPlane3DQGfby::setRequirements()
   {
