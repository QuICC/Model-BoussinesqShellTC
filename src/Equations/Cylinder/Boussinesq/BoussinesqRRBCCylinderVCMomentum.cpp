/** 
 * @file BoussinesqRRBCCylinderVCMomentum.cpp
...
namespace Equations {
   ...
   BoussinesqRRBCCylinderVCMomentum::BoussinesqRRBCCylinderVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBCCylinderVCMomentum::~BoussinesqRRBCCylinderVCMomentum()
   {
   }

   void BoussinesqRRBCCylinderVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRRBCCylinderVCMomentum::setRequirements()
   {
