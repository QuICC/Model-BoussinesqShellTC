/** 
 * @file BoussinesqRRBCylinderVCMomentum.cpp
 * @brief Source of the implementation of the vector momentum equation in rotating Rayleigh-Benard convection in a cylinder
...
namespace Equations {
   ...
   BoussinesqRRBCylinderVCMomentum::BoussinesqRRBCylinderVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBCylinderVCMomentum::~BoussinesqRRBCylinderVCMomentum()
   {
   }

   void BoussinesqRRBCylinderVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRRBCylinderVCMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
      // Get Prandtl number
   ...
   void BoussinesqRRBCylinderVCMomentum::setRequirements()
   {
