/** 
 * @file BoussinesqRBCCylinderVCMomentum.cpp
...
namespace Equations {
   ...
   BoussinesqRBCCylinderVCMomentum::BoussinesqRBCCylinderVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRBCCylinderVCMomentum::~BoussinesqRBCCylinderVCMomentum()
   {
   }

   void BoussinesqRBCCylinderVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRBCCylinderVCMomentum::setNLComponents()
   {
   ...
   void BoussinesqRBCCylinderVCMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
      // Get Prandtl number
   ...
   void BoussinesqRBCCylinderVCMomentum::setRequirements()
   {
