/** 
 * @file BoussinesqRBCCylinderVCTransport.cpp
...
namespace Equations {
   ...
   BoussinesqRBCCylinderVCTransport::BoussinesqRBCCylinderVCTransport(SharedEquationParameters spEqParams)
   ...
   BoussinesqRBCCylinderVCTransport::~BoussinesqRBCCylinderVCTransport()
   {
   }

   void BoussinesqRBCCylinderVCTransport::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, false);
   }

   void BoussinesqRBCCylinderVCTransport::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRBCCylinderVCTransport::setRequirements()
   {
