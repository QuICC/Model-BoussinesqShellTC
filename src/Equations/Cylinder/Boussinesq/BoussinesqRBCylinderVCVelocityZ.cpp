/** 
 * @file BoussinesqRBCylinderVCVelocityZ.cpp
 * @brief Source of the implementation of th momentum equation for the Z component in Rayleigh-Benard convection in a cylinder 
...
// Class include
//
#include "Equations/Cylinder/Boussinesq/BoussinesqRBCylinderVCVelocityZ.hpp"
...
namespace Equations {
   ...
   BoussinesqRBCylinderVCVelocityZ::BoussinesqRBCylinderVCVelocityZ(SharedEquationParameters spEqParams)
   ...
   BoussinesqRBCylinderVCVelocityZ::~BoussinesqRBCylinderVCVelocityZ()
   {
   }

   void BoussinesqRBCylinderVCVelocityZ::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqRBCylinderVCVelocityZ::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRBCylinderVCVelocityZ::setRequirements()
   {
