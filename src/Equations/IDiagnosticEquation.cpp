...
namespace Equations {
   ...
   void IDiagnosticEquation::init()
   {
      this->setCoupling();
   }

   void IDiagnosticEquation::computeLinear(FieldComponents::Spectral::Id compId, DecoupledZMatrix& eqField, const int eqStart, SpectralFieldId fieldId, const DecoupledZMatrix& linField, const int linStart, const int matIdx) const
   {
      // Safety asserts
   ...
   void IDiagnosticEquation::computeLinear(FieldComponents::Spectral::Id compId, DecoupledZMatrix& eqField, const int eqStart, SpectralFieldId fieldId, const MatrixZ& linField, const int linStart, const int matIdx) const
   {
      // Safety asserts
   ...
   void IDiagnosticEquation::computeLinear(FieldComponents::Spectral::Id compId, MatrixZ& eqField, const int eqStart, SpectralFieldId fieldId, const DecoupledZMatrix& linField, const int linStart, const int matIdx) const
   {
      // Safety asserts
   ...
   void IDiagnosticEquation::computeLinear(FieldComponents::Spectral::Id compId, MatrixZ& eqField, const int eqStart, SpectralFieldId fieldId, const MatrixZ& linField, const int linStart, const int matIdx) const
   {
      // Safety asserts
   ...
   void IDiagnosticEquation::applyNLQuasiInverse(FieldComponents::Spectral::Id id, DecoupledZMatrix& storage, const int matIdx, const int start)
   {
   ...
   void IDiagnosticEquation::applyNLQuasiInverse(FieldComponents::Spectral::Id id, MatrixZ& storage, const int matIdx, const int start)
   {
      // Get iterator to set of quasi-inverse matrices
      std::map<FieldComponents::Spectral::Id, std::vector<SparseMatrix> >::const_iterator qIt = this->mNLMatrices.find(id);
