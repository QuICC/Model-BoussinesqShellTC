/** 
 * @file BoussinesqRRBAnnulusVCVelocityZ.cpp
 * @brief Source of the implementation of the momentum equation for the Z component in rtoating Rayleigh-Benard convection in a cylindrical annulus 
...
namespace Equations {
   ...
   BoussinesqRRBAnnulusVCVelocityZ::BoussinesqRRBAnnulusVCVelocityZ(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBAnnulusVCVelocityZ::~BoussinesqRRBAnnulusVCVelocityZ()
   {
   }

   void BoussinesqRRBAnnulusVCVelocityZ::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqRRBAnnulusVCVelocityZ::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRRBAnnulusVCVelocityZ::setRequirements()
   {
