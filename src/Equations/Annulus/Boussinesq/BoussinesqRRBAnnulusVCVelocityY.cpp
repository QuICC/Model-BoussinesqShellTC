/** 
 * @file BoussinesqRRBAnnulusVCVelocityY.cpp
 * @brief Source of the implementation of th momentum equation for the Y component in rotating Rayleigh-Benard convection in a cylindrical annulus
...
namespace Equations {
   ...
   BoussinesqRRBAnnulusVCVelocityY::BoussinesqRRBAnnulusVCVelocityY(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBAnnulusVCVelocityY::~BoussinesqRRBAnnulusVCVelocityY()
   {
   }

   void BoussinesqRRBAnnulusVCVelocityY::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqRRBAnnulusVCVelocityY::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRRBAnnulusVCVelocityY::setRequirements()
   {
