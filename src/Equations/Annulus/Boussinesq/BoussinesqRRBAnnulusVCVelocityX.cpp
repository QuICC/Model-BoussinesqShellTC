/** 
 * @file BoussinesqRRBAnnulusVCVelocityX.cpp
 * @brief Source of the implementation of th momentum equation for the X component in rotating Rayleigh-Benard convection in a cylindrical annulus
...
namespace Equations {
   ...
   BoussinesqRRBAnnulusVCVelocityX::BoussinesqRRBAnnulusVCVelocityX(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBAnnulusVCVelocityX::~BoussinesqRRBAnnulusVCVelocityX()
   {
   }

   void BoussinesqRRBAnnulusVCVelocityX::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, true, false);
   }

   void BoussinesqRRBAnnulusVCVelocityX::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRRBAnnulusVCVelocityX::setRequirements()
   {
