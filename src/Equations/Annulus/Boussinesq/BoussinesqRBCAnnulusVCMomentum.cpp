/** 
 * @file BoussinesqRBCAnnulusVCMomentum.cpp
...
namespace Equations {
   ...
   BoussinesqRBCAnnulusVCMomentum::BoussinesqRBCAnnulusVCMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqRBCAnnulusVCMomentum::~BoussinesqRBCAnnulusVCMomentum()
   {
   }

   void BoussinesqRBCAnnulusVCMomentum::setCoupling()
   {
   ...
   void BoussinesqRBCAnnulusVCMomentum::setNLComponents()
   {
   ...
   void BoussinesqRBCAnnulusVCMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
      // Get Prandtl number
   ...
   void BoussinesqRBCAnnulusVCMomentum::setRequirements()
   {
