/** 
 * @file BoussinesqRRBCAnnulusVCTransport.cpp
 * @brief Source of the implementation of the transport equation in rotating Rayleigh-Benard convection in a cylindrical annulus
...
namespace Equations {
   ...
   BoussinesqRRBCAnnulusVCTransport::BoussinesqRRBCAnnulusVCTransport(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBCAnnulusVCTransport::~BoussinesqRRBCAnnulusVCTransport()
   {
   }

   void BoussinesqRRBCAnnulusVCTransport::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, false);
   }

   void BoussinesqRRBCAnnulusVCTransport::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRRBCAnnulusVCTransport::setRequirements()
   {
