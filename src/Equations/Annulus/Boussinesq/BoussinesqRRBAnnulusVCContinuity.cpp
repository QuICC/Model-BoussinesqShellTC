/** 
 * @file BoussinesqRRBAnnulusVCContinuity.cpp
...
namespace Equations {
   ...
   BoussinesqRRBAnnulusVCContinuity::BoussinesqRRBAnnulusVCContinuity(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBAnnulusVCContinuity::~BoussinesqRRBAnnulusVCContinuity()
   {
   }
   ...
   void BoussinesqRRBAnnulusVCContinuity::setRequirements()
   {
