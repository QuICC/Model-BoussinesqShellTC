/** 
 * @file TestWLFBackwardScalar.cpp
 * @brief Source of the implementation of a test equation for the WLF scheme with exact known scalar spectral space solution
...
namespace Equations {
   ...
   TestWLFBackwardScalar::TestWLFBackwardScalar()
   ...
   void TestWLFBackwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestWLFBackwardScalar::setSolutionType(const TestWLFBackwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestWLFBackwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestWLFBackwardScalar::setRequirements()
   {
   ...
   void TestWLFBackwardScalar::init()
   {
   ...
   MHDFloat TestWLFBackwardScalar::scalarPoint(const int i, const int j, const int k) const
   {
   ...
   void TestWLFBackwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestWLFBackwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
