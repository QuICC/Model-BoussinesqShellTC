/** 
 * @file TestSLFBackwardScalar.cpp
 * @brief Source of the implementation of a test equation for the SLF scheme with exact known scalar spectral space solution
...
namespace Equations {
   ...
   TestSLFBackwardScalar::TestSLFBackwardScalar()
   ...
   void TestSLFBackwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestSLFBackwardScalar::setSolutionType(const TestSLFBackwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestSLFBackwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestSLFBackwardScalar::setRequirements()
   {
   ...
   void TestSLFBackwardScalar::init()
   {
   ...
   MHDFloat TestSLFBackwardScalar::scalarPoint(const int i, const int j, const int k) const
   {
   ...
   void TestSLFBackwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestSLFBackwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
