/** 
 * @file TestFFFForwardScalar.cpp
 * @brief Source of the implementation of a test equation for the FFF scheme with exact known scalar physical space solution
...
namespace Equations {
   ...
   TestFFFForwardScalar::TestFFFForwardScalar()
   ...
   void TestFFFForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestFFFForwardScalar::setSolutionType(const TestFFFForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestFFFForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestFFFForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestFFFForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestFFFForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestFFFForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestFFFForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestFFFForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
