/** 
 * @file TestCFTForwardScalar.cpp
 * @brief Source of the implementation of a test equation for the CFT scheme with exact known scalar physical space solution
...
namespace Equations {
   ...
   TestCFTForwardScalar::TestCFTForwardScalar()
   ...
   void TestCFTForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestCFTForwardScalar::setSolutionType(const TestCFTForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestCFTForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestCFTForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestCFTForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestCFTForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestCFTForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestCFTForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestCFTForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
