/** 
 * @file TestWFTForwardScalar.cpp
 * @brief Source of the implementation of a test equation for the WFT scheme with exact known scalar physical space solution
...
namespace Equations {
   ...
   TestWFTForwardScalar::TestWFTForwardScalar()
   ...
   void TestWFTForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestWFTForwardScalar::setSolutionType(const TestWFTForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestWFTForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestWFTForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestWFTForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestWFTForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestWFTForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestWFTForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestWFTForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
