/** 
 * @file TestTFFForwardScalar.cpp
 * @brief Source of the implementation of a test equation for the TFF scheme with exact known scalar physical space solution
...
namespace Equations {
   ...
   TestTFFForwardScalar::TestTFFForwardScalar()
   ...
   void TestTFFForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestTFFForwardScalar::setSolutionType(const TestTFFForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestTFFForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestTFFForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestTFFForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestTFFForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestTFFForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestTFFForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestTFFForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
