...
namespace Equations {
   ...
   TestTTTForwardScalar::TestTTTForwardScalar()
   ...
   void TestTTTForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestTTTForwardScalar::setSolutionType(const TestTTTForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestTTTForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestTTTForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestTTTForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestTTTForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestTTTForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestTTTForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestTTTForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
