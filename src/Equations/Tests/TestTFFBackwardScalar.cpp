/** 
 * @file TestTFFBackwardScalar.cpp
 * @brief Source of the implementation of a test equation for the TFF scheme with exact known scalar spectral space solution
...
namespace Equations {
   ...
   TestTFFBackwardScalar::TestTFFBackwardScalar()
   ...
   void TestTFFBackwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestTFFBackwardScalar::setSolutionType(const TestTFFBackwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestTFFBackwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestTFFBackwardScalar::setRequirements()
   {
   ...
   void TestTFFBackwardScalar::init()
   {
   ...
   MHDFloat TestTFFBackwardScalar::scalarPoint(const int i, const int j, const int k) const
   {
   ...
   void TestTFFBackwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestTFFBackwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
