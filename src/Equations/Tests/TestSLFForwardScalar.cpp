/** 
 * @file TestSLFForwardScalar.cpp
 * @brief Source of the implementation of a test equation for the SLF scheme with exact known scalar physical space solution
...
namespace Equations {
   ...
   TestSLFForwardScalar::TestSLFForwardScalar()
   ...
   void TestSLFForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestSLFForwardScalar::setSolutionType(const TestSLFForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestSLFForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestSLFForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestSLFForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestSLFForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestSLFForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestSLFForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestSLFForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
