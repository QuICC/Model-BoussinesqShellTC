...
namespace Equations {
   ...
   void TestTTTDiffusion3D::createBoundaries(FieldComponents::Spectral::Id compId, const int matIdx)
   {
      //EigenSelector::boundaryRow(*this, compId, matIdx);
   }

   DecoupledZSparse TestTTTDiffusion3D::operatorRow(const IEquation::OperatorRowId opId, FieldComponents::Spectral::Id compId, const int matIdx) const
   {
   ...
   void linearBlock(const TestTTTDiffusion3D& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs)
   {
      assert(eigs.size() == 1);
   ...
   void timeBlock(const TestTTTDiffusion3D& eq, FieldComponents::Spectral::Id compId, DecoupledZSparse& mat, const SpectralFieldId fieldId, const std::vector<MHDFloat>& eigs)
   {
      assert(eigs.size() == 1);
      MHDFloat k = eigs.at(0);
