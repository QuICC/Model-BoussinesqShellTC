/** 
 * @file TestWLFForwardScalar.cpp
 * @brief Source of the implementation of a test equation for the WLF scheme with exact known scalar physical space solution
...
namespace Equations {
   ...
   TestWLFForwardScalar::TestWLFForwardScalar()
   ...
   void TestWLFForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestWLFForwardScalar::setSolutionType(const TestWLFForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestWLFForwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestWLFForwardScalar::setRequirements()
   {
   ...
   MHDFloat TestWLFForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
   ...
   MHDFloat TestWLFForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      if(this->mTypeId == ZERO)
      {
   ...
   void TestWLFForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestWLFForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat TestWLFForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
