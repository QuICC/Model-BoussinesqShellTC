/** 
 * @file TestTTTBackwardScalar.cpp
 * @brief Source of the implementation of a test equation for the TTT scheme with exact known scalar spectral space solution
...
namespace Equations {
   ...
   TestTTTBackwardScalar::TestTTTBackwardScalar()
   ...
   void TestTTTBackwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestTTTBackwardScalar::setSolutionType(const TestTTTBackwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestTTTBackwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestTTTBackwardScalar::setRequirements()
   {
   ...
   void TestTTTBackwardScalar::init()
   {
   ...
   MHDFloat TestTTTBackwardScalar::scalarPoint(const int i, const int j, const int k) const
   {
   ...
   void TestTTTBackwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestTTTBackwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
