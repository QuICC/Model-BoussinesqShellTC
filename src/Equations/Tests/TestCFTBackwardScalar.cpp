/** 
 * @file TestCFTBackwardScalar.cpp
 * @brief Source of the implementation of a test equation for the CFT scheme with exact known scalar spectral space solution
...
namespace Equations {
   ...
   TestCFTBackwardScalar::TestCFTBackwardScalar()
   ...
   void TestCFTBackwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestCFTBackwardScalar::setSolutionType(const TestCFTBackwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestCFTBackwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestCFTBackwardScalar::setRequirements()
   {
   ...
   void TestCFTBackwardScalar::init()
   {
   ...
   MHDFloat TestCFTBackwardScalar::scalarPoint(const int i, const int j, const int k) const
   {
   ...
   void TestCFTBackwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestCFTBackwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
