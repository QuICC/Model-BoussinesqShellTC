/** 
 * @file TestTFTBackwardScalar.cpp
 * @brief Source of the implementation of a test equation for the TFT scheme with exact known scalar spectral space solution
...
namespace Equations {
   ...
   TestTFTBackwardScalar::TestTFTBackwardScalar()
   ...
   void TestTFTBackwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void TestTFTBackwardScalar::setSolutionType(const TestTFTBackwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void TestTFTBackwardScalar::setCoupling()
   {
      // Get X dimension
   ...
   void TestTFTBackwardScalar::setRequirements()
   {
   ...
   void TestTFTBackwardScalar::init()
   {
   ...
   MHDFloat TestTFTBackwardScalar::scalarPoint(const int i, const int j, const int k) const
   {
   ...
   void TestTFTBackwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat TestTFTBackwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
