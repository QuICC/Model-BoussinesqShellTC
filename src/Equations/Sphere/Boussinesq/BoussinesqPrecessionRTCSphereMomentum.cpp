/** 
 * @file BoussinesqPrecessionRTCSphereMomentum.cpp
 * @brief Source of the implementation of the vector Navier-Stokes equation in the Boussinesq combined precession and rotating thermal convection in a sphere model
...
namespace Equations {
   ...
   BoussinesqPrecessionRTCSphereMomentum::BoussinesqPrecessionRTCSphereMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqPrecessionRTCSphereMomentum::~BoussinesqPrecessionRTCSphereMomentum()
   {
   }

   void BoussinesqPrecessionRTCSphereMomentum::setCoupling()
   {
   ...
   void BoussinesqPrecessionRTCSphereMomentum::setNLComponents()
   {
   ...
   void BoussinesqPrecessionRTCSphereMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id compId) const
   {  
      ///
   ...
   void BoussinesqPrecessionRTCSphereMomentum::setRequirements()
   {
