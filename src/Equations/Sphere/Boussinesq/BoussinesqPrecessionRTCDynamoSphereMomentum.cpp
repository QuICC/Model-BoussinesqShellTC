/** 
 * @file BoussinesqPrecessionRTCDynamoSphereMomentum.cpp
 * @brief Source of the implementation of the vector Navier-Stokes equation in the Boussinesq combined precession and thermal convection dynamo in a sphere model
...
namespace Equations {
   ...
   BoussinesqPrecessionRTCDynamoSphereMomentum::BoussinesqPrecessionRTCDynamoSphereMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqPrecessionRTCDynamoSphereMomentum::~BoussinesqPrecessionRTCDynamoSphereMomentum()
   {
   }

   void BoussinesqPrecessionRTCDynamoSphereMomentum::setCoupling()
   {
