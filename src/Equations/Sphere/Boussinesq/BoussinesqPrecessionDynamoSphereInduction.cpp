/** 
 * @file BoussinesqPrecessionDynamoSphereInduction.cpp
 * @brief Source of the implementation of the vector induction equation in the Boussinesq precession dynamo in a sphere model
...
namespace Equations {
   ...
   BoussinesqPrecessionDynamoSphereInduction::BoussinesqPrecessionDynamoSphereInduction(SharedEquationParameters spEqParams)
   ...
   BoussinesqPrecessionDynamoSphereInduction::~BoussinesqPrecessionDynamoSphereInduction()
   {
   }

   void BoussinesqPrecessionDynamoSphereInduction::setCoupling()
   {
   ...
   void BoussinesqPrecessionDynamoSphereInduction::setNLComponents()
   {
   ...
   void BoussinesqPrecessionDynamoSphereInduction::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id compId) const
   {
      ///
   ...
   void BoussinesqPrecessionDynamoSphereInduction::setRequirements()
   {
