/** 
 * @file BoussinesqPrecessionDynamoSphereMomentum.cpp
 * @brief Source of the implementation of the vector Navier-Stokes equation in the Boussinesq precession dynamo in a sphere model
...
namespace Equations {
   ...
   BoussinesqPrecessionDynamoSphereMomentum::BoussinesqPrecessionDynamoSphereMomentum(SharedEquationParameters spEqParams)
   ...
   BoussinesqPrecessionDynamoSphereMomentum::~BoussinesqPrecessionDynamoSphereMomentum()
   {
   }

   void BoussinesqPrecessionDynamoSphereMomentum::setCoupling()
   {
   ...
   void BoussinesqPrecessionDynamoSphereMomentum::setNLComponents()
   {
   ...
   void BoussinesqPrecessionDynamoSphereMomentum::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id compId) const
   {
      ///
   ...
   void BoussinesqPrecessionDynamoSphereMomentum::setRequirements()
   {
