/** 
 * @file BoussinesqRRBCBoxVCTransport.cpp
...
namespace Equations {
   ...
   BoussinesqRRBCBoxVCTransport::BoussinesqRRBCBoxVCTransport(SharedEquationParameters spEqParams)
   ...
   BoussinesqRRBCBoxVCTransport::~BoussinesqRRBCBoxVCTransport()
   {
   }

   void BoussinesqRRBCBoxVCTransport::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, false);
   }

   void BoussinesqRRBCBoxVCTransport::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void BoussinesqRRBCBoxVCTransport::setRequirements()
   {
