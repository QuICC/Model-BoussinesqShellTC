...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Test/AFT/Linear/PhysicalModel.hpp )
...
namespace Linear {
   ...
   const std::string PhysicalModel::PYMODULE = "test_aftscheme";

   const std::string PhysicalModel::PYCLASS = "TestAFTScheme";
