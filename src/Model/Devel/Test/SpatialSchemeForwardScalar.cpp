/** 
 * @file SpatialSchemeForwardScalar.cpp
...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Test/SpatialSchemeForwardScalar.hpp )
...
namespace Test {
   ...
   SpatialSchemeForwardScalar::SpatialSchemeForwardScalar()
   ...
   void SpatialSchemeForwardScalar::setIdentity(const PhysicalNames::Id name)
   {
      // Set the name
      this->setName(name);
   ...
   void SpatialSchemeForwardScalar::setSolutionType(const SpatialSchemeForwardScalar::SolutionTypeId id)
   {
      this->mTypeId = id;
   }

   void SpatialSchemeForwardScalar::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::TRIVIAL, 0, true, false);
   }

   void SpatialSchemeForwardScalar::setRequirements()
   {
   ...
   void SpatialSchemeForwardScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   MHDFloat SpatialSchemeForwardScalar::computeScalarError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
   ...
   MHDFloat SpatialSchemeForwardScalar::computeGradientError() const
   {
      // Maximum error
      MHDFloat error = 0.0;
...
// Set test problem for TTT scheme
   ...
   Datatypes::PhysicalScalarType::PointType SpatialSchemeForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat y, const MHDFloat x) const
   {
   ...
   MHDFloat SpatialSchemeForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat y, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
...
// Set test problem for TFT scheme
   ...
   Datatypes::PhysicalScalarType::PointType SpatialSchemeForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x) const
   {
      Datatypes::PhysicalScalarType::PointType val;
   ...
   MHDFloat SpatialSchemeForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      Datatypes::PhysicalScalarType::PointType grad;
...
// Set test problem for TFF scheme
   ...
   Datatypes::PhysicalScalarType::PointType SpatialSchemeForwardScalar::scalarPoint(const MHDFloat ph, const MHDFloat th, const MHDFloat x) const
   {
      Datatypes::PhysicalScalarType::PointType val;
   ...
   MHDFloat SpatialSchemeForwardScalar::gradientPoint(const MHDFloat ph, const MHDFloat th, const MHDFloat x, const FieldComponents::Physical::Id compId) const
   {
      Datatypes::PhysicalScalarType::PointType grad;
...
// Set test problem for FFF scheme
   ...
   Datatypes::PhysicalScalarType::PointType SpatialSchemeForwardScalar::scalarPoint(const MHDFloat ph, const MHDFloat th, const MHDFloat kh) const
   {
      Datatypes::PhysicalScalarType::PointType val;
   ...
   MHDFloat SpatialSchemeForwardScalar::gradientPoint(const MHDFloat ph, const MHDFloat th, const MHDFloat kh, const FieldComponents::Physical::Id compId) const
   {
      Datatypes::PhysicalScalarType::PointType grad;
...
// Set test problem for CFT scheme
   ...
   Datatypes::PhysicalScalarType::PointType SpatialSchemeForwardScalar::scalarPoint(const MHDFloat z, const MHDFloat th, const MHDFloat r) const
   {
      Datatypes::PhysicalScalarType::PointType val;
   ...
   MHDFloat SpatialSchemeForwardScalar::gradientPoint(const MHDFloat z, const MHDFloat th, const MHDFloat r, const FieldComponents::Physical::Id compId) const
   {
      Datatypes::PhysicalScalarType::PointType val;
...
// Set test problem for SLF scheme
   ...
   Datatypes::PhysicalScalarType::PointType SpatialSchemeForwardScalar::scalarPoint(const MHDFloat ph, const MHDFloat th, const MHDFloat r) const
   {
      Datatypes::PhysicalScalarType::PointType val;
   ...
   MHDFloat SpatialSchemeForwardScalar::gradientPoint(const MHDFloat ph, const MHDFloat th, const MHDFloat r, const FieldComponents::Physical::Id compId) const
   {
      Datatypes::PhysicalScalarType::PointType val;
