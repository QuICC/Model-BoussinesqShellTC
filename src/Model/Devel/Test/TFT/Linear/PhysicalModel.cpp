...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Test/TFT/Linear/PhysicalModel.hpp )
...
namespace Linear {
   ...
   const std::string PhysicalModel::PYMODULE = "test_tftscheme";

   const std::string PhysicalModel::PYCLASS = "TestTFTScheme";
