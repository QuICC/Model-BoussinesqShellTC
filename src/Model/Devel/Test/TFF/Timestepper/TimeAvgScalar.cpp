...
namespace Timestepper {
   ...
   TimeAvgScalar::TimeAvgScalar(SharedEquationParameters spEqParams)
   ...
   TimeAvgScalar::~TimeAvgScalar()
   {
   }

   void TimeAvgScalar::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::TRIVIAL, 0, false, false);
   }

   void TimeAvgScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void TimeAvgScalar::setRequirements()
   {
