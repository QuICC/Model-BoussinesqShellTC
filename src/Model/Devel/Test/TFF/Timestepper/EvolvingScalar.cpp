...
namespace Timestepper {
   ...
   EvolvingScalar::EvolvingScalar(SharedEquationParameters spEqParams)
   ...
   EvolvingScalar::~EvolvingScalar()
   {
   }

   void EvolvingScalar::setCoupling()
   {
      this->defineCoupling(FieldComponents::Spectral::SCALAR, CouplingInformation::PROGNOSTIC, 0, true, false);
   }

   void EvolvingScalar::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id id) const
   {
   ...
   void EvolvingScalar::setRequirements()
   {
