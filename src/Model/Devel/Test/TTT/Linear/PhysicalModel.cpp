...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Test/TTT/Linear/PhysicalModel.hpp )
...
namespace Linear {
   ...
   const std::string PhysicalModel::PYMODULE = "test_tttscheme";

   const std::string PhysicalModel::PYCLASS = "TestTTTScheme";
   ...
   void PhysicalModel::addStates(SharedStateGenerator spGen)
   {
      ...
      if(true)
      {
         ...
         spExact->setModeOptions(-1e1, 1.0, 2e0, 1.0, -3e0, 1.0);

         // Add scalar exact initial state generator
         spExact = spGen->addScalarEquation<Equations::CartesianExactScalarState>();
         spExact->setIdentity(PhysicalNames::VELOCITYY);
         spExact->setStateType(Equations::CartesianExactStateIds::POLYPOLYPOLY);
         spExact->setModeOptions(1e0, 10.0, 5e0, 1.0, 3e0, 1.0);

         // Add scalar exact initial state generator
         spExact = spGen->addScalarEquation<Equations::CartesianExactScalarState>();
         spExact->setIdentity(PhysicalNames::VELOCITYZ);
         spExact->setStateType(Equations::CartesianExactStateIds::POLYPOLYPOLY);
         spExact->setModeOptions(-1e1, 1.0, 1e0, 2.0, 2e1, 10.0);

         // Add scalar exact initial state generator
         spExact = spGen->addScalarEquation<Equations::CartesianExactScalarState>();
         spExact->setIdentity(PhysicalNames::TEMPERATURE);
         spExact->setStateType(Equations::CartesianExactStateIds::POLYPOLYPOLY);
         spExact->setModeOptions(2e0, 3.0, 3e0, 10.0, -1e2, 1.0);
