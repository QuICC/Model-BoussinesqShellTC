...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Test/CFT/Linear/PhysicalModel.hpp )
...
namespace Linear {
   ...
   const std::string PhysicalModel::PYMODULE = "test_cftscheme";

   const std::string PhysicalModel::PYCLASS = "TestCFTScheme";
