...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTCDynamo/Explicit/PhysicalModel.hpp )

// Project includes
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTCDynamo/Transport.hpp )
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTCDynamo/Momentum.hpp )
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTCDynamo/Induction.hpp )
...
namespace PrecessionRTCDynamo {

namespace Explicit {

   const std::string PhysicalModel::PYMODULE = "boussinesq_precessionrtcdynamosphere_std";

   const std::string PhysicalModel::PYCLASS = "BoussinesqPrecessionRTCDynamoSphereStd";

   void PhysicalModel::addEquations(SharedSimulation spSim)
   {
      // Add transport equation
      spSim->addScalarEquation<Equations::Boussinesq::Sphere::PrecessionRTCDynamo::Transport>();
                                                              
      // Add Navier-Stokes equation                           
      spSim->addVectorEquation<Equations::Boussinesq::Sphere::PrecessionRTCDynamo::Momentum>();
                                                              
      // Add induction equation                               
      spSim->addVectorEquation<Equations::Boussinesq::Sphere::PrecessionRTCDynamo::Induction>();
   }
