...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTC/Explicit/PhysicalModel.hpp )

// Project includes
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTC/Transport.hpp )
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionRTC/Momentum.hpp )
...
namespace Explicit {
   ...
   const std::string PhysicalModel::PYMODULE = "boussinesq_precessionrtcsphere_std";

   const std::string PhysicalModel::PYCLASS = "BoussinesqPrecessionRTCSphereStd";

   void PhysicalModel::addEquations(SharedSimulation spSim)
   {
      // Add transport equation
      spSim->addScalarEquation<Equations::Boussinesq::Sphere::PrecessionRTC::Transport>();
                                                            
      // Add Navier-Stokes equation                         
      spSim->addVectorEquation<Equations::Boussinesq::Sphere::PrecessionRTC::Momentum>();
   }
