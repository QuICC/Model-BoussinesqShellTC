...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionDynamo/Explicit/PhysicalModel.hpp )

// Project includes
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionDynamo/Momentum.hpp )
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/PrecessionDynamo/Induction.hpp )
...
namespace Explicit {
   ...
   const std::string PhysicalModel::PYMODULE = "boussinesq_precessiondynamosphere_std";

   const std::string PhysicalModel::PYCLASS = "BoussinesqPrecessionDynamoSphereStd";

   void PhysicalModel::addEquations(SharedSimulation spSim)
   {
      // Add Navier-Stokes equation
      spSim->addVectorEquation<Equations::Boussinesq::Sphere::PrecessionDynamo::Momentum>();
                                                            
      // Add induction equation                             
      spSim->addVectorEquation<Equations::Boussinesq::Sphere::PrecessionDynamo::Induction>();
   }
