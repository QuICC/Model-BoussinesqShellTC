...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Sphere/RTC/Implicit/PhysicalModel.hpp )
...
namespace Implicit {
   ...
   const std::string PhysicalModel::PYMODULE = "boussinesq_rtcsphere";

   const std::string PhysicalModel::PYCLASS = "BoussinesqRTCSphere";
