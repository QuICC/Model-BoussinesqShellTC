...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Shell/TC/Implicit/PhysicalModel.hpp )
...
namespace Implicit {
   ...
   const std::string PhysicalModel::PYMODULE = "boussinesq_tcshell";

   const std::string PhysicalModel::PYCLASS = "BoussinesqTCShell";
