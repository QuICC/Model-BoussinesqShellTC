/** 
 * @file MomentumBase.cpp
 * @brief Source of the base implementation of the vector Navier-Stokes equation in the Boussinesq spherical Couette in a spherical shell model
...
namespace Couette {
   ...
   MomentumBase::MomentumBase(SharedEquationParameters spEqParams)
   ...
   void MomentumBase::setCoupling()
   {
         ...
         this->defineCoupling(FieldComponents::Spectral::TOR, CouplingInformation::PROGNOSTIC, start, use_nonlinear, false, true);
   ...
   void MomentumBase::setNLComponents()
   {
   ...
   void MomentumBase::computeNonlinear(Datatypes::PhysicalScalarType& rNLComp, FieldComponents::Physical::Id compId) const
   {  
   ...
   void MomentumBase::setRequirements()
   {
