...
// Class include
//
#include MAKE_STR( QUICC_MODEL_PATH/Boussinesq/Shell/Free/Explicit/PhysicalModel.hpp )
...
namespace Explicit {
   ...
   const std::string PhysicalModel::PYMODULE = "boussinesq_freeshell_std";

   const std::string PhysicalModel::PYCLASS = "BoussinesqFreeShellStd";

   void PhysicalModel::addEquations(SharedSimulation spSim)
   {
      // Add Navier-Stokes equation
      spSim->addVectorEquation<Equations::Boussinesq::Shell::Free::Momentum>();
   }
