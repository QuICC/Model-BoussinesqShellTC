/** 
 * @file GalerkinAnnulusChebyshev.cpp
 * @brief Source of the implementation of the spectral Chebyshev Galerkin operators for an annulus radius
...
namespace Spectral {
   ...
   const GalerkinAnnulusChebyshev::FlagType GalerkinAnnulusChebyshev::ZERO_VALUE_LEFT= (1 << 0);
   const GalerkinAnnulusChebyshev::FlagType GalerkinAnnulusChebyshev::ZERO_VALUE_RIGHT = (1 << 1);
   const GalerkinAnnulusChebyshev::FlagType GalerkinAnnulusChebyshev::ZERO_D1_LEFT = (1 << 2);
   const GalerkinAnnulusChebyshev::FlagType GalerkinAnnulusChebyshev::ZERO_D1_RIGHT = (1 << 3);
   const GalerkinAnnulusChebyshev::FlagType GalerkinAnnulusChebyshev::ZERO_D2_LEFT = (1 << 4);
   const GalerkinAnnulusChebyshev::FlagType GalerkinAnnulusChebyshev::ZERO_D2_RIGHT = (1 << 5);

   GalerkinAnnulusChebyshev::GalerkinAnnulusChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq)
   ...
   GalerkinAnnulusChebyshev::~GalerkinAnnulusChebyshev()
   {
   }

   int GalerkinAnnulusChebyshev::nN() const
   {
      return this->mN - this->mNeq;
   }

   int GalerkinAnnulusChebyshev::nBc() const
   {
      return 0;
   }

   void GalerkinAnnulusChebyshev::identifyCondition(const Boundary::BCVector& bcs)
   {
   ...
   void GalerkinAnnulusChebyshev::createStencil()
   {
   ...
   SparseMatrix GalerkinAnnulusChebyshev::restrictL(const int nEq, const int cols) const
   {
      assert(cols > 0);
      assert(cols-nEq > 0);
   ...
   void GalerkinAnnulusChebyshev::zeroValueLeft(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinAnnulusChebyshev::zeroValueRight(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS VALUE(-1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinAnnulusChebyshev::zeroValue(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 2);
   ...
   void GalerkinAnnulusChebyshev::zeroD1Left(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinAnnulusChebyshev::zeroD1Right(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS D1(-1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinAnnulusChebyshev::zeroD1(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 2);
   ...
   void GalerkinAnnulusChebyshev::zeroD2Left(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinAnnulusChebyshev::zeroD2Right(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS D2(1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinAnnulusChebyshev::zeroD2(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinAnnulusChebyshev::zeroVD1(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 4);
   ...
   void GalerkinAnnulusChebyshev::zeroVD2(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 4);
   ...
   void GalerkinAnnulusChebyshev::zeroD1D2(SparseMatrix& rStencil, const int cols) const
   {
   ...
   MHDFloat GalerkinAnnulusChebyshev::c(const int n) const
   {
      if(n == 0)
      {
   ...
   MHDFloat GalerkinAnnulusChebyshev::c_1(const int n) const
   {
      if(n == 0)
      {
         #ifdef GEOMHDISCC_CHEBYSHEV_HAS_C
