/** 
 * @file GalerkinCylinderChebyshev.cpp
 * @brief Source of the implementation of the spectral Chebyshev Galerkin operators for a cylinder radius
...
namespace Spectral {
   ...
   const GalerkinCylinderChebyshev::FlagType GalerkinCylinderChebyshev::ZERO_VALUE_LEFT= (1 << 0);
   const GalerkinCylinderChebyshev::FlagType GalerkinCylinderChebyshev::ZERO_VALUE_RIGHT = (1 << 1);
   const GalerkinCylinderChebyshev::FlagType GalerkinCylinderChebyshev::ZERO_D1_LEFT = (1 << 2);
   const GalerkinCylinderChebyshev::FlagType GalerkinCylinderChebyshev::ZERO_D1_RIGHT = (1 << 3);
   const GalerkinCylinderChebyshev::FlagType GalerkinCylinderChebyshev::ZERO_D2_LEFT = (1 << 4);
   const GalerkinCylinderChebyshev::FlagType GalerkinCylinderChebyshev::ZERO_D2_RIGHT = (1 << 5);

   GalerkinCylinderChebyshev::GalerkinCylinderChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq)
   ...
   GalerkinCylinderChebyshev::~GalerkinCylinderChebyshev()
   {
   }

   int GalerkinCylinderChebyshev::nN() const
   {
      return this->mN - this->mNeq;
   }

   int GalerkinCylinderChebyshev::nBc() const
   {
      return 0;
   }

   void GalerkinCylinderChebyshev::identifyCondition(const Boundary::BCVector& bcs)
   {
   ...
   void GalerkinCylinderChebyshev::createStencil()
   {
   ...
   SparseMatrix GalerkinCylinderChebyshev::restrictL(const int nEq, const int cols) const
   {
      assert(cols > 0);
      assert(cols-nEq > 0);
   ...
   void GalerkinCylinderChebyshev::zeroValueLeft(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinCylinderChebyshev::zeroValueRight(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS VALUE(-1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinCylinderChebyshev::zeroValue(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 2);
   ...
   void GalerkinCylinderChebyshev::zeroD1Left(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinCylinderChebyshev::zeroD1Right(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS D1(-1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinCylinderChebyshev::zeroD1(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 2);
   ...
   void GalerkinCylinderChebyshev::zeroD2Left(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinCylinderChebyshev::zeroD2Right(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS D2(1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinCylinderChebyshev::zeroD2(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinCylinderChebyshev::zeroVD1(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 4);
   ...
   void GalerkinCylinderChebyshev::zeroVD2(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 4);
   ...
   void GalerkinCylinderChebyshev::zeroD1D2(SparseMatrix& rStencil, const int cols) const
   {
   ...
   MHDFloat GalerkinCylinderChebyshev::c(const int n) const
   {
      if(n == 0)
      {
   ...
   MHDFloat GalerkinCylinderChebyshev::c_1(const int n) const
   {
      if(n == 0)
      {
         #ifdef GEOMHDISCC_CHEBYSHEV_HAS_C
