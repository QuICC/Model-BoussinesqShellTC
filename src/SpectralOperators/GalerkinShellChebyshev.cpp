/** 
 * @file GalerkinShellChebyshev.cpp
 * @brief Source of the implementation of the spectral Chebyshev Galerkin operators for a shell radius
...
namespace Spectral {
   ...
   const GalerkinShellChebyshev::FlagType GalerkinShellChebyshev::ZERO_VALUE_LEFT= (1 << 0);
   const GalerkinShellChebyshev::FlagType GalerkinShellChebyshev::ZERO_VALUE_RIGHT = (1 << 1);
   const GalerkinShellChebyshev::FlagType GalerkinShellChebyshev::ZERO_D1_LEFT = (1 << 2);
   const GalerkinShellChebyshev::FlagType GalerkinShellChebyshev::ZERO_D1_RIGHT = (1 << 3);
   const GalerkinShellChebyshev::FlagType GalerkinShellChebyshev::ZERO_D2_LEFT = (1 << 4);
   const GalerkinShellChebyshev::FlagType GalerkinShellChebyshev::ZERO_D2_RIGHT = (1 << 5);

   GalerkinShellChebyshev::GalerkinShellChebyshev(const MHDFloat c, const int nN, const Boundary::BCVector& bcs, const int nEq)
   ...
   GalerkinShellChebyshev::~GalerkinShellChebyshev()
   {
   }

   int GalerkinShellChebyshev::nN() const
   {
      return this->mN - this->mNeq;
   }

   int GalerkinShellChebyshev::nBc() const
   {
      return 0;
   }

   void GalerkinShellChebyshev::identifyCondition(const Boundary::BCVector& bcs)
   {
   ...
   void GalerkinShellChebyshev::createStencil()
   {
   ...
   SparseMatrix GalerkinShellChebyshev::restrictL(const int nEq, const int cols) const
   {
      assert(cols > 0);
      assert(cols-nEq > 0);
   ...
   void GalerkinShellChebyshev::zeroValueLeft(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinShellChebyshev::zeroValueRight(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS VALUE(-1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinShellChebyshev::zeroValue(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 2);
   ...
   void GalerkinShellChebyshev::zeroD1Left(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinShellChebyshev::zeroD1Right(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS D1(-1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinShellChebyshev::zeroD1(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 2);
   ...
   void GalerkinShellChebyshev::zeroD2Left(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinShellChebyshev::zeroD2Right(SparseMatrix& rStencil, const int cols) const
   {
      std::cerr << "---------- THIS D2(1) STENCIL IS UNTESTED ------------" << std::endl;
      assert(cols > 1);
   ...
   void GalerkinShellChebyshev::zeroD2(SparseMatrix& rStencil, const int cols) const
   {
   ...
   void GalerkinShellChebyshev::zeroVD1(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 4);
   ...
   void GalerkinShellChebyshev::zeroVD2(SparseMatrix& rStencil, const int cols) const
   {
      assert(cols > 4);
   ...
   void GalerkinShellChebyshev::zeroD1D2(SparseMatrix& rStencil, const int cols) const
   {
   ...
   MHDFloat GalerkinShellChebyshev::c(const int n) const
   {
      if(n == 0)
      {
   ...
   MHDFloat GalerkinShellChebyshev::c_1(const int n) const
   {
      if(n == 0)
      {
         #ifdef GEOMHDISCC_CHEBYSHEV_HAS_C
